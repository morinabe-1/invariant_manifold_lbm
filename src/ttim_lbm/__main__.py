...
def main() -> None:
    ...
    elif arguments.study == "q007e":
        result = run_q007e_study()
    elif arguments.study == "q007f":
        result = run_q007f_study()
    elif arguments.study == "q007g":
        result = run_q007g_study()
    elif arguments.study == "q007h":
        result = run_q007h_study()
    elif arguments.study == "q007h1":
        result = run_q007h1_study()
    elif arguments.study == "q007i":
        result = run_q007i_study()
    elif arguments.study == "q008a":
        result = run_q008a_study()
    else:
        result = run_q008c_study()
