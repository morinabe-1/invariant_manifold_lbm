...
- repaired exact mapの\(C^2\)以上のgraph smoothness、phase-sensitive degrees 5--90 external
...
`0.004057305895234305`であり、degree-4 external nonresonanceを認証した。missing rangeはdegrees 5--90である。
