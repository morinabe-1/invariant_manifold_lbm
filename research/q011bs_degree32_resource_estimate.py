"""Q011bs design-only degree-thirty-two block-support resource audit."""
...
EXPECTED_FIRST_COUNTS = (0, 3, 11, 18)
EXPECTED_LAST_COUNTS = (32, 0, 0, 0)
EXPECTED_COUNT_TUPLE_DIGEST = "d648cd59c455a743db0548afd8b7cc478e33c1f1e57b10f4d5209d26ee6fc299"
EXPECTED_EXTERNAL_GROUP_DIGEST = "8a07693f5eed3e4c208bbad98a465625cfeac7e33bb74954a38331b06943472b"
EXPECTED_OVERLAP_RECORD_DIGEST = "139872625b1999804dbe13cac61b2ff17242ed8e1573ddcd5ba185d2d58b5436"
EXPECTED_TARGET_RECORD_DIGEST = "59e242e396998aabed2417faf204a190e2b6632840c59d5807f505830c6f056a"
EXPECTED_INVENTORY_DIGEST = "21e031c48c326f82af26f8e0aa403d3e17a6837beb40472d96554e6f91aac20a"

EXPECTED_PRIOR_IDENTIFIER_COUNT = 1_032
EXPECTED_ACTIVE_REUSED_IDENTIFIER_COUNT = 892
EXPECTED_INACTIVE_RETAINED_IDENTIFIER_COUNT = 140
EXPECTED_ADDED_TARGET_IDENTIFIER_COUNT = 156
EXPECTED_ACTIVE_IDENTIFIER_COUNT = 1_048
EXPECTED_FINAL_IDENTIFIER_COUNT = 1_188
EXPECTED_PRIOR_RECORD_DIGEST = "9a7db3a67d90687cc6a5aa84bd6fb329a8d09355f610513fc5be68c18d59b5ac"
EXPECTED_ACTIVE_REUSED_RECORD_DIGEST = (
    "b321e05b5da183cb3ac29457b02c2c35685d1c7da4c3434c173339e8fb7f9e1b"
)
...
EXPECTED_ADDED_IDENTIFIER_DIGEST = (
    "81c12da81bb56a27d0b478db565e60329b1b277b903095c1b348653d4c611a35"
)
EXPECTED_ADDED_RECORD_DIGEST = "d854109ec11d012de7058440d9491d0b903c6512c14b76596b9fd5cf0de55ad6"
EXPECTED_ACTIVE_RECORD_DIGEST = "40ea81a4de49dd0a4b30b9d87b1643a0a9f5f96229fea2cd94d524e4f951f0ca"
EXPECTED_FINAL_RECORD_DIGEST = "818f1af5c2f40ae728e5fc89d57e19c2d71028e1868e50612582c50d834af345"
...
EXPECTED_CLASS_POWER_KEY_DIGEST = (
    "c3558afcfc74b38323b08ba4a4b8d836fdfd03b698d65d8f94ae8dd1f2cd7102"
)
EXPECTED_GROUP_POOL_KEY_COUNT = 126
EXPECTED_GROUP_POOL_KEY_DIGEST = (
    "fb3d46c5dfd162f078557ecf9f9df1f050ca431f7a7cff751b8ee78786fe9860"
)
EXPECTED_GROUP_SIGNATURE_COUNT = 996
EXPECTED_PAIR_POOL_KEY_COUNT = 691
EXPECTED_PAIR_POOL_KEY_DIGEST = (
    "b5538eebc1fe95f701e55e2f41a5b893289ac4152e08e62ba0595617622ef95d"
)
EXPECTED_PAIR_SIGNATURE_ENTRY_COUNT = 30_749
...
EXPECTED_MAXIMUM_AGGREGATE_MONOMIAL_COUNT = 3_073_110_104_064
...
EXPECTED_PROJECTED_SECONDS = Fraction(73_507_677_333, 72_180_980_000)
EXPECTED_DOUBLE_SAFETY_SECONDS = Fraction(73_507_677_333, 36_090_490_000)
...
GO_DECISION = "go_for_degree_thirty_two_coalesced_preregistration"
STOP_DECISION = "stop_before_degree_thirty_two_coalesced_full_sweep"
INCONCLUSIVE_DECISION = "inconclusive_resource_audit"
SCIENTIFIC_OUTCOME = "not_evaluated"
ACTUAL_RESONANCE_OUTCOME = "not_evaluated"

Q011BR_ARTIFACT_SHA256 = "63a5a3cc5076edef2dfeb5e8f0d82cb588b9de4436fbebc57e0e39349b9e1cfe"
Q011BR_RUNNER_SHA256 = "c6e3e6db74ee71421938bf3fd3df760f22480bde6f5d589c576acd634d9b9d02"
Q011BR_DIGEST_NAMES = (
    "input_digest_sha256",
...
def _sealed_input_audit() -> tuple[dict[str, Any], dict[str, dict[str, Any]]]:
    prior, artifacts = q011br._sealed_input_audit()
    artifact_path = _artifact_directory() / "q011br_degree31_coalesced_sweep.json"
    runner_path = Path(q011br.__file__).resolve()
    artifact = json.loads(artifact_path.read_text(encoding="utf-8"))
    cycle = artifact["cycle"]
    digests = tuple(cycle[name] for name in Q011BR_DIGEST_NAMES)
    theorem = cycle["theorem_consequence"]
    checks = {
        "q011br_forty_eight_prior_artifacts_and_helpers_reproduce": bool(
            prior["passed"]
            and prior["direct_digest_count"] == 230
            and len(artifacts) == 48
            and all(prior["checks"].values())
        ),
        "q011br_artifact_sha256_matches": _file_sha256(artifact_path)
        == Q011BR_ARTIFACT_SHA256,
        "q011br_runner_sha256_matches": bool(
            _file_sha256(runner_path) == Q011BR_RUNNER_SHA256
            and artifact["runner_source"]["sha256"] == Q011BR_RUNNER_SHA256
        ),
        "q011br_section_digests_match": digests == Q011BR_DIGESTS,
        "q011br_accepted_degree_thirty_one_outcome_reproduces": bool(
            artifact["study_gate"] == "passed"
            and artifact["scientific_outcome"] == "accepted"
            and artifact["actual_resonance_outcome"]
            == q011br.ACCEPTED_ACTUAL_RESONANCE_OUTCOME
            and cycle["failed_validity_order"] == []
            and cycle["failed_hypothesis_order"] == []
            and theorem["degree_thirty_one_external_nonresonance_is_certified"]
        ...
        "q011br_claim_boundary_is_present": bool(cycle["claim_boundary"]),
        "q011br_package_source_metadata_matches": artifact["source"] == source_metadata(),
        "q011br_artifact_is_strict_finite_json": bool(
            _all_numeric_values_finite(artifact)
            and _strict_json_serializable(artifact)
            and json.dumps(artifact, allow_nan=False)
        ),
        "two_hundred_thirty_four_direct_digests_are_sealed": (
            prior["direct_digest_count"] + len(digests) == 234
        ),
    }
    artifacts["q011br"] = artifact
    return (
        {
            "prior_q011br_sealed_input_audit": prior,
            "q011br": {
                "artifact_filename": artifact_path.name,
                "artifact_sha256": _file_sha256(artifact_path),
                "runner_filename": runner_path.name,
                "runner_sha256": _file_sha256(runner_path),
                "digest_names": list(Q011BR_DIGEST_NAMES),
...
def _degree_thirty_two_inventory_audit(
    ...
    checks = {
        ...
        "q011u_degree_thirty_two_record_is_unique_and_complete": bool(
...
def _degree_thirty_two_envelope_audit(
    artifacts: dict[str, dict[str, Any]],
    ...
    prior_records = artifacts["q011bq"]["cycle"]["degree_thirty_one_envelope_audit"][
        "final_disc_records"
    ]
    ...
    checks = {
        ...
        "all_q011bq_records_are_retained_bitwise": bool(
        ...
        "registered_degree_thirty_two_extension_reproduces": bool(
    ...
    audit = {
        ...
        "prior_q011bq_identifier_count": len(prior_by_identifier),
        "active_reused_q011bq_identifier_count": len(common_identifiers),
        "inactive_retained_q011bq_identifier_count": len(inactive_identifiers),
        "added_target_identifier_count": len(added_identifiers),
        "removed_q011bq_identifier_count": 0,
...
def _degree_thirty_two_resource_audit(
    ...
    record["full_degree_thirty_two_monomial_list_retained"] = False
    ...
    checks = {
        ...
        "streaming_design_does_not_evaluate_degree_thirty_two_relations": bool(
            not record["full_degree_thirty_two_monomial_list_retained"]
...
def _registered_parameters() -> dict[str, Any]:
    return {
        ...
        "degree_thirty_two_relations_evaluated": False,
        "resource_limits": RESOURCE_LIMITS,
        "resource_limits_are_inherited_unchanged_from_q011ap": True,
        "go_decision": GO_DECISION,
        "stop_decision": STOP_DECISION,
        "degree_thirty_two_external_nonresonance_claimed": False,
...
def run_degree_thirty_two_resource_audit() -> dict[str, Any]:
    ...
    (
        ...
        _external_indices,
        target_groups,
    ) = _degree_thirty_two_inventory_audit(artifacts)
    envelope, merged_classes, _ = _degree_thirty_two_envelope_audit(
        artifacts, selected_groups, external_merged, target_groups
    )
    resource = _degree_thirty_two_resource_audit(
        merged_classes, selected_groups, overlap_counts, target_groups
    )
    registered = _registered_parameters()
    runner = _runner_source_metadata()
    input_sections = {"registered_parameters": registered, "sealed_input_audit": sealed}
    inventory_sections = {"degree_thirty_two_inventory_audit": inventory}
    envelope_sections = {"degree_thirty_two_envelope_audit": envelope}
    resource_sections = {"degree_thirty_two_coalesced_resource_audit": resource}
    ...
    validity_gates = {
        "q011br_and_all_prior_proof_objects_are_sealed": {
            "passed": sealed["passed"],
            "threshold": "49 artifacts and 234 direct digests reproduce",
            "value": sealed["checks"],
        },
        "degree_thirty_two_inventory_reproduces": {
            "passed": inventory["passed"],
            "threshold": "6545 aggregates split as 4238 old plus 2307 overlap",
            "value": inventory["checks"],
        },
        "degree_thirty_two_monotone_envelope_and_source_hulls_reproduce": {
            "passed": envelope["passed"],
            "threshold": "1032 prior records retained, 156 added and six source hulls",
            "value": envelope["checks"],
        },
        "degree_thirty_two_design_only_resource_contract_reproduces": {
            "passed": resource["passed"],
            "threshold": "registered exact combinatorial resources with zero relations",
            "value": resource["checks"],
        },
        "no_degree_thirty_two_relation_object_is_constructed": {
            "passed": bool(
        ...
        "section_digests_runner_and_json_are_strict": {
            "passed": bool(
                ...
                == len(resource_digest)
                == 64
                and runner["filename"] == "q011bs_degree32_resource_estimate.py"
    ...
    cycle = {
        "question": (
            "Can the degree-thirty-two block-support-coalesced full sweep be "
    ...
    cycle["theorem_consequence"] = {
        "degree_thirty_two_coalesced_full_sweep_preregistration_is_resource_supported": decision
        == GO_DECISION,
        "degree_thirty_two_external_nonresonance_is_certified": False,
        "an_actual_degree_thirty_two_external_resonance_is_ruled_out": False,
        "certified_external_nonresonance_degrees": list(range(2, 32)),
        "degree_91_and_higher_modulus_tail_is_preserved": True,
        "missing_external_nonresonance_degrees": list(range(32, 91)),
    ...
    cycle["claim_boundary"] = (
        "This design-only audit concerns the degree-thirty-two modulus-overlap "
        "inventory, six Q011as source hulls, all 1024 current target discs, the "
        "1188-record monotone proof inventory, exact combinatorial resource counts and "
        "calibrated projections for the fixed 17x17 repaired exact map on one fixed "
        "conservation leaf. It evaluates no degree-thirty-two product-target relation "
        "and certifies no degree-thirty-two nonresonance, actual resonance, minimum "
    ...
    cycle["next_change"] = (
        "Preregister the Q011bt degree-thirty-two full sweep with fixed inputs, "
        "arithmetic and acceptance rules."
        if decision == GO_DECISION
        else "Redesign only the first failed degree-thirty-two resource dimension "
        "before any degree-thirty-two relation evaluation."
        if decision == STOP_DECISION
        else "Repair only the first Q011bs validity failure before changing the design."
    )
    if not (
        ...
        raise RuntimeError("Q011bs cycle failed strict serialization or digest")
    return cycle


def run_q011bs_study() -> dict[str, Any]:
    cycle = run_degree_thirty_two_resource_audit()
    ...
    return {
        ...
        "arithmetic_runtime": {
            ...
            "degree_thirty_two_product_enclosure": "not constructed",
            "degree_thirty_two_fourier_coefficient_matrices": "not constructed",
            "degree_thirty_two_relation_classification": "not evaluated",
        ...
        "mathematical_scope": {
            "diagnostic": "design-only degree-32 block-support resource feasibility",
            "grid": [SIZE, SIZE],
            "fixed_conservation_leaf": True,
            "degree": DEGREE,
            "degree_thirty_two_external_nonresonance_claim": False,
            "actual_degree_thirty_two_external_resonance_ruled_out_claim": False,
