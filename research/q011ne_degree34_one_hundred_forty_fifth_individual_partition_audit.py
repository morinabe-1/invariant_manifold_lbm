"""Q011ne individual-disc partition audit for Q011cb flatten ordinal 144."""
...
EXPECTED_CLASS_TOTALS = (1, 12, 8, 1, 5, 7)
EXPECTED_SOURCE_COUNTS = (1, 0, 12, 0, 8, 0, 1, 0, 0, 5, 0, 7)
EXPECTED_FIRST_COMPATIBLE_COUNTS = (0, 1, 0, 12, 0, 8, 0, 1, 0, 5, 5, 2)
...
EXPECTED_OCCUPIED_RECORD_DIGEST = "9581f959de70b6701ccc2275375ff37ddb4b0a068a6e1c1b89ebda1926a6cd85"
EXPECTED_IDENTIFIER_ORDER_DIGEST = (
    "5063f9638bf5dfbe8b90cf76615268ba4ba6f3b3825d56aac972329725852257"
)
EXPECTED_ALLOCATION_DIGEST = "08b606c5165af2b2a3c04b35d37f0c389215561fa683477997f1c208940cf6ae"
EXPECTED_COMPATIBLE_DIGEST = "f16ee601194a0380800e567ce1ee4604c62beaaa56b8a01cb9257bbba1514cc7"

EXPECTED_PARENT_WAVE_MULTIPLICITY = 1_255
EXPECTED_PARENT_BLOCK_ZERO_MULTIPLICITY = 0
EXPECTED_PARENT_INTERSECTION_WIDTH_HEX = "0x1.4b3345725d157p-31"
EXPECTED_PARENT_CENTER_RELATION = "target_below_product"
EXPECTED_PARENT_CENTER_GAP_HEX = "0x1.32d7561108691p-28"
EXPECTED_PARENT_WITNESS_DIGEST = "21969b3889d88577d8f42eec7898f172ef6b22a2e421c4894adf1b356d4d4332"
EXPECTED_PARENT_PRODUCT_DIGEST = "e860877829b63e5ae7e430b127d179c9f8ca1951887e2a22582ddb16e9c0fcbc"
...
Q011ND_ARTIFACT_SHA256 = "530191ecd05f1b8d7e56e0431c06c536ee27e38332023ea5b8d10caff5c52410"
Q011ND_RUNNER_SHA256 = "739242cf7319818f54bfbc1b71a4ebf688fd2ce07ff622c505bde52931c6a49a"
Q011ND_DIGEST_NAMES = (
    "input_digest_sha256",
...
Q011ND_DIGESTS = (
    "adf0feed3dc29c96c65bbe805c0ed52a621e509442ccb38bb82e3e8fca5d956c",
    ...
    "84f95a6f365b83f3c7f615312cfa42b22c0aca951d5ec28fdeeeaa7653825522",
)
EXPECTED_Q011ND_STREAM_DIGEST = "12bf0b57ebf63bf48f83a262abdcfff7e5857a40eed3cbdec3304f2955905abc"
EXPECTED_ORDINAL_ONE_HUNDRED_FORTY_THREE_RESOLUTION_DIGEST = (
    "cba06ceb15335a288a1ea6e0d24caf4f450a26e54b3b51f5e46e84b7526d6868"
)
ALLOCATION_STREAM_DOMAIN = "q011ne-individual-partition-allocation-records-v1"

INERT_CLASSIFICATION = (
    "the individual-disc partition is interval-inert for the one-hundred-forty-fifth "
    "Q011cb witness"
)
RESOLVED_CLASSIFICATION = (
    "the one-hundred-forty-fifth Q011cb witness is resolved by individual partition"
)
EFFECTIVE_PERSISTENT_CLASSIFICATION = (
    "the individual-disc partition changes intervals but the one-hundred-forty-fifth "
    "Q011cb witness persists"
)
INCONCLUSIVE_CLASSIFICATION = "the Q011ne individual-disc partition audit is inconclusive"
...
def _protocol_globals_are_restored() -> bool:
    return bool(
        ...
        and q011nd._protocol_globals_are_restored()
    )
...
def _sealed_input_audit_cached() -> tuple[
    ...
    prior, artifacts = q011nd._sealed_input_audit()
    ...
    digests = tuple(cycle[name] for name in Q011ND_DIGEST_NAMES)
    checks = {
        "q011nd_three_hundred_forty_six_prior_artifacts_and_helpers_reproduce": bool(
            prior["passed"]
            and prior["artifact_count"] == 346
            and prior["direct_digest_count"] == 1_569
            and len(artifacts) == 346
            and all(prior["checks"].values())
        ),
        "q011nd_artifact_and_runner_sha256_match": bool(
            _file_sha256(artifact_path) == Q011ND_ARTIFACT_SHA256
            and _file_sha256(runner_path) == Q011ND_RUNNER_SHA256
            and artifact["runner_source"]["sha256"] == Q011ND_RUNNER_SHA256
        ),
        "q011nd_section_digests_match": digests == Q011ND_DIGESTS,
        "q011nd_valid_phase_resolution_and_boundary_reproduce": bool(
        ...
        "q011nd_registered_ordinal_one_hundred_forty_three_resolution_reproduces": bool(
        ...
        "q011nd_artifact_is_finite_strict_json": bool(
            _all_numeric_values_finite(artifact)
            and _strict_json_serializable(artifact)
            and json.dumps(artifact, allow_nan=False)
        ),
        "one_thousand_five_hundred_seventy_four_direct_digests_are_sealed": (
            prior["direct_digest_count"] + len(digests) == 1_574
        ),
    }
    artifacts["q011nd"] = artifact
    return (
        {
            "prior_q011nd_sealed_input_audit": prior,
            "q011nd": {
                "artifact_filename": artifact_path.name,
                "artifact_sha256": _file_sha256(artifact_path),
                "runner_filename": runner_path.name,
                "runner_sha256": _file_sha256(runner_path),
                "digest_names": list(Q011ND_DIGEST_NAMES),
...
def _fixed_individual_input_audit(
    ...
    q011nd_cycle = artifacts["q011nd"]["cycle"]
    q011nd_comparison = q011nd_cycle["complex_phase_product_disc_audit"]
    selection["checks"][
        "ordinals_zero_through_one_hundred_forty_three_are_sealed_phase_resolutions"
    ] = bool(
        previous_check
        and q011nd_cycle["theorem_consequence"][
            "component_safe_complex_phase_discs_resolve_one_hundred_forty_fourth_q011cb_witness"
        ]
        and q011nd_comparison["global_minimum_margin_witness"][
            "witness_digest_sha256"
        ]
        == EXPECTED_ORDINAL_ONE_HUNDRED_FORTY_THREE_RESOLUTION_DIGEST
    )
    selection["checks"][
        "registered_ordinal_one_hundred_forty_four_parent_witness_reproduces"
    ] = registered_check
    ...
    selection["previous_phase_resolved_ordinals"] = list(range(144))
    selection["ordinal_one_hundred_forty_three_resolution_digest_sha256"] = (
        EXPECTED_ORDINAL_ONE_HUNDRED_FORTY_THREE_RESOLUTION_DIGEST
    )
    selection["one_hundred_forty_fifth_parent_witness"] = selection.pop(
        "third_parent_witness"
    )
    selection["one_hundred_forty_fifth_parent_witness_digest_sha256"] = (
        selection.pop("third_parent_witness_digest_sha256")
    )
    selection["passed"] = all(selection["checks"].values())
    fixed["one_hundred_forty_fifth_parent_witness_selection_audit"] = selection
    fixed["checks"].pop("registered_third_parent_selection_reproduces")
    fixed["checks"][
        "registered_one_hundred_forty_fifth_parent_selection_reproduces"
    ] = selection["passed"]
...
def _interval_record(lower: Fraction, upper: Fraction) -> dict[str, Any]:
    if not lower <= upper:
        raise RuntimeError("Q011ne constructed an unordered interval")
    return {
...
def run_degree_thirty_four_one_hundred_forty_fifth_individual_partition_audit() -> dict[str, Any]:
    ...
    validity_gates = {
        "q011nd_and_all_prior_proof_objects_are_sealed": {
            "passed": sealed["passed"],
            "threshold": "347 artifacts and 1574 direct digests reproduce",
            "value": sealed["checks"],
        },
        "registered_one_hundred_forty_fifth_parent_witness_reproduces": {
            "passed": selection["passed"],
            "threshold": "ordinal 144, class counts, 1255 multiplicity and exact witness",
            "value": selection[
                "one_hundred_forty_fifth_parent_witness_digest_sha256"
            ],
        },
        ...
        "all_class_total_degree_and_output_constraints_close": {
            ...
            "threshold": "1255 allocations, fixed class totals, degree 34 and output block 7",
        ...
        "strict_section_digests_runner_and_protocol_provenance_reproduce": {
            "passed": bool(
                ...
                == 64
                and runner["filename"]
                == "q011ne_degree34_one_hundred_forty_fifth_individual_partition_audit.py"
    ...
    diagnostic_gates = {
        "only_the_registered_one_hundred_forty_fifth_q011cb_signature_is_refined": {
            "passed": bool(
            ...
            "threshold": "ordinal 144 only, one target and no other aggregate",
    ...
    cycle = {
        "question": (
            "Does splitting Q011cb flatten ordinal 144 into twelve singleton "
    ...
    prior_theorem = artifacts["q011nd"]["cycle"]["theorem_consequence"]
    cycle["theorem_consequence"] = {
        "individual_partition_is_interval_inert_for_one_hundred_forty_fifth_q011cb_witness": inert,
        "one_hundred_forty_fifth_q011cb_witness_is_resolved_by_individual_partition": resolved,
        "individual_partition_changes_intervals_but_one_hundred_forty_fifth_q011cb_witness_persists": (
            effective_persistent
        ),
        "q011nd_ordinal_one_hundred_forty_three_phase_resolution_is_preserved": True,
        **{
            name: value
    ...
    cycle["claim_boundary"] = (
        "This diagnostic concerns only Q011cb flatten ordinal 144, its 1255 "
        ...
        "It uses ordinals 0 through 143 only as sealed selection boundaries and does "
        "not reevaluate them. It does not evaluate complex phase, the later 44655 "
    ...
    cycle["next_change"] = (
        "Preregister Q011nf to expand only the registered 1255 wave allocations into component-safe complex phase discs."
        if inert
        else "Preregister Q011nf to audit flatten ordinal 145 in registered order."
        if resolved
        else (
            "Preregister Q011nf to refine only the first remaining individual-allocation overlap by component-safe complex phase."
        )
        if effective_persistent
        else "Repair only the first Q011ne validity failure."
    )
    if not (
        ...
        raise RuntimeError("Q011ne cycle failed strict serialization or digest")
    return cycle


def run_q011ne_study() -> dict[str, Any]:
    cycle = run_degree_thirty_four_one_hundred_forty_fifth_individual_partition_audit()
    ...
    return {
        ...
        "mathematical_scope": {
            "diagnostic": (
                "one-hundred-forty-fifth Q011cb witness individual-disc partition"
            ),
            "grid": [SIZE, SIZE],
