...
- TT ranks: `[1, 6, 6, 3, 1]`
- TT parameters: 657
- box-dense/TT storage ratio: `3.33`
- natural sparse-fiber/TT storage ratio: `0.863`
...
持つ567-parameter 表現より大きい。従って、自然な疎表現に対する圧縮優位性は棄却された。
...
biorthogonal continuation は eigenvalue collision の前後で branch/cluster identity
を path-independent に保てるか。
