"""Q011ba design-only degree-twenty-three block-support resource audit."""
...
q011ay = q011az.q011ay
q011ap = q011ay.q011ap
q011as = q011ay.q011as
q011b = q011ay.q011b
q011u = q011ay.q011u
q011z = q011ay.q011z
...
EXPECTED_EXPANDED_CONTROL_COUNT = 98_280
EXPECTED_OLD_SEPARATED_AGGREGATE_COUNT = 2_161
EXPECTED_OVERLAP_AGGREGATE_COUNT = 439
EXPECTED_SELECTED_GROUP_SIZES = (8, 4, 4, 8)
EXPECTED_UNIQUE_EXTERNAL_GROUP_COUNT = 26
EXPECTED_TARGET_IDENTIFIER_COUNT = 300
EXPECTED_MULTI_TARGET_AGGREGATE_COUNT = 14
EXPECTED_MAXIMUM_EXTERNAL_COMPONENT_COUNT = 2
EXPECTED_TARGET_BLOCK_COUNTS = (20, 12, 12, 18, 26, 38, 20, 4, 10, 10, 4, 20, 38, 26, 18, 12, 12)
EXPECTED_FIRST_COUNTS = (0, 1, 16, 6)
EXPECTED_LAST_COUNTS = (23, 0, 0, 0)
EXPECTED_COUNT_TUPLE_DIGEST = "831c1a4148af3de8f54b970bf69332d479881fb73841cab2ac69ce21a88cb011"
EXPECTED_EXTERNAL_GROUP_DIGEST = "0d8b457f374f84f88000983085236cfcdf1a6714cef633ebcf4ab338b9efaf25"
EXPECTED_OVERLAP_RECORD_DIGEST = "e54fb4a6ba3212ec816dd204a0b83dc94a72d2fb284754691ef6e725feaea983"
EXPECTED_TARGET_RECORD_DIGEST = "968c2a14ceb7ec2d24240e68308b6f0d84599ca492d3f114b3a8ffbb875d3ab4"
EXPECTED_INVENTORY_DIGEST = "b19f8d2abbd7d8e6e56e48991dee9c4154a4521455ef1a9939a545e893a87a79"

EXPECTED_PRIOR_IDENTIFIER_COUNT = 308
EXPECTED_ACTIVE_REUSED_IDENTIFIER_COUNT = 276
EXPECTED_INACTIVE_RETAINED_IDENTIFIER_COUNT = 32
EXPECTED_ADDED_TARGET_IDENTIFIER_COUNT = 48
EXPECTED_ACTIVE_IDENTIFIER_COUNT = 324
EXPECTED_FINAL_IDENTIFIER_COUNT = 356
EXPECTED_PRIOR_RECORD_DIGEST = "b987d5025f745a441d274e32f0823f05ca5be2522a6ec0762aae412e2277aacc"
...
EXPECTED_ADDED_RECORD_DIGEST = "771be5b30f8d56ad42d3914b3f75177e3f382b12183727ceb12f17c0f81b5cd2"
EXPECTED_ACTIVE_RECORD_DIGEST = "9b48dde5243efe3b14588e346804f587e083121f4a84badaa0869faa9b87b0d3"
EXPECTED_FINAL_RECORD_DIGEST = "ce14eaf3da422fdd4f3e46d41777eba079d1d6d929203941602621252feec2f9"
EXPECTED_OLD_CLASS_COUNTS = (4, 2, 3, 6)
EXPECTED_MERGED_CLASS_COUNTS = (1, 1, 2, 2)
EXPECTED_HULL_RECORD_DIGEST = q011ay.EXPECTED_HULL_RECORD_DIGEST
EXPECTED_MERGED_MEMBERSHIP_DIGEST = q011ay.EXPECTED_MERGED_MEMBERSHIP_DIGEST
...
EXPECTED_GROUP_POOL_KEY_COUNT = 83
...
EXPECTED_PROJECTED_SECONDS = Fraction(135_072_685_053, 1_154_895_680_000)
EXPECTED_DOUBLE_SAFETY_SECONDS = Fraction(135_072_685_053, 577_447_840_000)
EXPECTED_TRACEMALLOC_SAFETY_BYTES = 106_659
EXPECTED_PROCESS_MEMORY_SAFETY_BYTES = 294_351

RESOURCE_LIMITS = dict(q011ay.RESOURCE_LIMITS)
GO_DECISION = "go_for_degree_twenty_three_coalesced_preregistration"
STOP_DECISION = "stop_before_degree_twenty_three_coalesced_full_sweep"
INCONCLUSIVE_DECISION = "inconclusive_resource_audit"
SCIENTIFIC_OUTCOME = "not_evaluated"
ACTUAL_RESONANCE_OUTCOME = "not_evaluated"

Q011AZ_ARTIFACT_SHA256 = "ca8dd35c73afc60f8aa66a7c9a57c17595c13123a3e613b6ab4125d55ee85c19"
Q011AZ_RUNNER_SHA256 = "d956b43019ff8067440db23c22bd1be689b588ded2281a09e0430b441a9a4b53"
Q011AZ_DIGEST_NAMES = (
    "input_digest_sha256",
...
def _sealed_input_audit() -> tuple[dict[str, Any], dict[str, dict[str, Any]]]:
    prior, artifacts = q011az._sealed_input_audit()
    artifact_path = _artifact_directory() / "q011az_degree22_coalesced_sweep.json"
    runner_path = Path(q011az.__file__).resolve()
    artifact = json.loads(artifact_path.read_text(encoding="utf-8"))
    cycle = artifact["cycle"]
    digests = tuple(cycle[name] for name in Q011AZ_DIGEST_NAMES)
    theorem = cycle["theorem_consequence"]
    checks = {
        "q011az_thirty_prior_artifacts_and_helpers_reproduce": bool(
            prior["passed"]
            and prior["direct_digest_count"] == 149
            and len(artifacts) == 30
            and all(prior["checks"].values())
        ),
        "q011az_artifact_sha256_matches": _file_sha256(artifact_path)
        == Q011AZ_ARTIFACT_SHA256,
        "q011az_runner_sha256_matches": bool(
            _file_sha256(runner_path) == Q011AZ_RUNNER_SHA256
            and artifact["runner_source"]["sha256"] == Q011AZ_RUNNER_SHA256
        ),
        "q011az_section_digests_match": digests == Q011AZ_DIGESTS,
        "q011az_accepted_degree_twenty_two_outcome_reproduces": bool(
            ...
            and theorem["degree_twenty_two_external_nonresonance_is_certified"]
        ...
        "q011az_claim_boundary_is_present": bool(cycle["claim_boundary"]),
        "q011az_package_source_metadata_matches": artifact["source"] == source_metadata(),
        "q011az_artifact_is_strict_finite_json": bool(
            _all_numeric_values_finite(artifact)
            and _strict_json_serializable(artifact)
            and json.dumps(artifact, allow_nan=False)
        ),
        "one_hundred_fifty_three_direct_digests_are_sealed": (
            prior["direct_digest_count"] + len(digests) == 153
        ),
    }
    artifacts["q011az"] = artifact
    return (
        {
            "prior_q011az_sealed_input_audit": prior,
            "q011az": {
                "artifact_filename": artifact_path.name,
                "artifact_sha256": _file_sha256(artifact_path),
                "runner_filename": runner_path.name,
                "runner_sha256": _file_sha256(runner_path),
                "digest_names": list(Q011AZ_DIGEST_NAMES),
...
def _degree_twenty_three_inventory_audit(
    ...
    checks = {
        ...
        "q011u_degree_twenty_three_record_is_unique_and_complete": bool(
...
def _degree_twenty_three_envelope_audit(
    artifacts: dict[str, dict[str, Any]],
    ...
    prior_records = artifacts["q011ay"]["cycle"]["degree_twenty_two_envelope_audit"][
        "final_disc_records"
    ]
    ...
    checks = {
        ...
        "all_q011ay_records_are_retained_bitwise": bool(
        ...
        "registered_degree_twenty_three_extension_reproduces": bool(
    ...
    audit = {
        ...
        "prior_q011ay_identifier_count": len(prior_by_identifier),
        "active_reused_q011ay_identifier_count": len(common_identifiers),
        "inactive_retained_q011ay_identifier_count": len(inactive_identifiers),
        "added_target_identifier_count": len(added_identifiers),
        "removed_q011ay_identifier_count": 0,
...
def _degree_twenty_three_resource_audit(
    ...
    record["full_degree_twenty_three_monomial_list_retained"] = False
    ...
    checks = {
        ...
        "streaming_design_does_not_evaluate_degree_twenty_three_relations": bool(
            not record["full_degree_twenty_three_monomial_list_retained"]
...
def _registered_parameters() -> dict[str, Any]:
    return {
        ...
        "degree_twenty_three_relations_evaluated": False,
        "resource_limits": RESOURCE_LIMITS,
        "resource_limits_are_inherited_unchanged_from_q011ap": True,
        "go_decision": GO_DECISION,
        "stop_decision": STOP_DECISION,
        "degree_twenty_three_external_nonresonance_claimed": False,
...
def run_degree_twenty_three_resource_audit() -> dict[str, Any]:
    ...
    (
        ...
        _external_indices,
        target_groups,
    ) = _degree_twenty_three_inventory_audit(artifacts)
    envelope, merged_classes, _ = _degree_twenty_three_envelope_audit(
        artifacts, selected_groups, external_merged, target_groups
    )
    resource = _degree_twenty_three_resource_audit(
        merged_classes, selected_groups, overlap_counts, target_groups
    )
    registered = _registered_parameters()
    runner = _runner_source_metadata()
    input_sections = {"registered_parameters": registered, "sealed_input_audit": sealed}
    inventory_sections = {"degree_twenty_three_inventory_audit": inventory}
    envelope_sections = {"degree_twenty_three_envelope_audit": envelope}
    resource_sections = {"degree_twenty_three_coalesced_resource_audit": resource}
    ...
    validity_gates = {
        "q011az_and_all_prior_proof_objects_are_sealed": {
            "passed": sealed["passed"],
            "threshold": "31 artifacts and 153 direct digests reproduce",
            "value": sealed["checks"],
        },
        "degree_twenty_three_inventory_reproduces": {
            "passed": inventory["passed"],
            "threshold": "2600 aggregates split as 2161 old plus 439 overlap",
            "value": inventory["checks"],
        },
        "degree_twenty_three_monotone_envelope_and_source_hulls_reproduce": {
            "passed": envelope["passed"],
            "threshold": "308 prior records retained, 48 added and six source hulls",
            "value": envelope["checks"],
        },
        "degree_twenty_three_design_only_resource_contract_reproduces": {
            "passed": resource["passed"],
            "threshold": "registered exact combinatorial resources with zero relations",
            "value": resource["checks"],
        },
        "no_degree_twenty_three_relation_object_is_constructed": {
            "passed": bool(
        ...
        "section_digests_runner_and_json_are_strict": {
            "passed": bool(
                ...
                == len(resource_digest)
                == 64
                and runner["filename"] == "q011ba_degree23_resource_estimate.py"
    ...
    cycle = {
        "question": (
            "Can the degree-twenty-three block-support-coalesced full sweep be "
    ...
    cycle["theorem_consequence"] = {
        "degree_twenty_three_coalesced_full_sweep_preregistration_is_resource_supported": decision
        == GO_DECISION,
        "degree_twenty_three_external_nonresonance_is_certified": False,
        "an_actual_degree_twenty_three_external_resonance_is_ruled_out": False,
        "certified_external_nonresonance_degrees": list(range(2, 23)),
        "degree_91_and_higher_modulus_tail_is_preserved": True,
        "missing_external_nonresonance_degrees": list(range(23, 91)),
    ...
    cycle["claim_boundary"] = (
        "This design-only audit concerns the degree-twenty-three modulus-overlap "
        "inventory, six Q011as source hulls, all 300 current target discs, the "
        "356-record monotone proof inventory, exact combinatorial resource counts and "
        "calibrated projections for the fixed 17x17 repaired exact map on one fixed "
        "conservation leaf. It evaluates no degree-twenty-three product-target relation "
        "and certifies no degree-twenty-three nonresonance, actual resonance, minimum "
    ...
    cycle["next_change"] = (
        "Preregister the Q011bb degree-twenty-three full sweep with fixed inputs, "
        "arithmetic and acceptance rules."
        if decision == GO_DECISION
        else "Redesign only the first failed degree-twenty-three resource dimension "
        "before any degree-twenty-three relation evaluation."
        if decision == STOP_DECISION
        else "Repair only the first Q011ba validity failure before changing the design."
    )
    if not (
        ...
        raise RuntimeError("Q011ba cycle failed strict serialization or digest")
    return cycle


def run_q011ba_study() -> dict[str, Any]:
    cycle = run_degree_twenty_three_resource_audit()
    ...
    return {
        ...
        "arithmetic_runtime": {
            ...
            "degree_twenty_three_product_enclosure": "not constructed",
            "degree_twenty_three_fourier_coefficient_matrices": "not constructed",
            "degree_twenty_three_relation_classification": "not evaluated",
        ...
        "mathematical_scope": {
            "diagnostic": "design-only degree-23 block-support resource feasibility",
            "grid": [SIZE, SIZE],
            "fixed_conservation_leaf": True,
            "degree": DEGREE,
            "degree_twenty_three_external_nonresonance_claim": False,
            "actual_degree_twenty_three_external_resonance_ruled_out_claim": False,
