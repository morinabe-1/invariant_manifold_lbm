"""Q011iv component-safe complex phase discs for Q011cb flatten ordinal eighty-seven."""
...
EXPECTED_WAVE_PROJECTION_DIGEST = "f2c8e2621629465ffd9005654ae8e12d1835fa95b1ae11044916c40b27a00439"
EXPECTED_PHASE_FIBER_HISTOGRAM = {10: 147, 18: 142, 24: 139, 28: 137, 30: 136}
EXPECTED_BRIDGE_FIBER_HISTOGRAM = {1: 701}
EXPECTED_BRIDGE_RECORD_DIGEST = "d2d693aab8754873cbc16155fa3b9ce5765eb2dab9f92108b63714153349f076"
EXPECTED_PAIRED_RECORD_DIGEST = "8524a93a59e733ea5a8cec730c23e23d0470a24e4507c277328ed3b7ab591f11"

Q011IU_ARTIFACT_SHA256 = "92fe055c7458ce113c4025030f0c83ddb621acef514cde9803e136a7ff443d7e"
Q011IU_RUNNER_SHA256 = "6d291d9f1d344f08d5effb4050bf1da901f7dae602191b646981554c2b49b762"
Q011IU_DIGEST_NAMES = (
    "input_digest_sha256",
...
EXPECTED_Q011IU_ALLOCATION_RECORD_DIGEST = (
    "b88a031b16ad491810477e5da637f49434832a0fb96909d78359aadf3fd48b64"
)

RESOLVED_CLASSIFICATION = (
    "the component-safe complex phase discs resolve the eighty-eighth Q011cb "
    "persistent refined witness"
)
PERSISTENT_CLASSIFICATION = (
    "the eighty-eighth Q011cb persistent refined witness persists under "
    "component-safe complex phase discs"
)
INCONCLUSIVE_CLASSIFICATION = "the Q011iv component-safe phase-disc audit is inconclusive"
...
def _q011iv_framed_record_digest() -> Any:
    return q011ih.q011cx._BASE_FRAMED_RECORD_DIGEST("q011iv-component-safe-phase-comparisons-v1")


def _q011iv_exact_fraction_sequence_sha256(
    _domain: bytes,
    values: tuple[Fraction, ...],
) -> str:
    return q011ih.q011cx._BASE_EXACT_FRACTION_SEQUENCE_SHA256(
        b"q011iv-complex-margin-expression-v1",
        values,
    )
...
def _protocol_globals_are_restored() -> bool:
    return bool(
        ...
        and q011iu._protocol_globals_are_restored()
    )


def _sealed_input_audit() -> tuple[dict[str, Any], dict[str, dict[str, Any]]]:
    prior, artifacts = q011iu._sealed_input_audit()
    ...
    digests = tuple(cycle[name] for name in Q011IU_DIGEST_NAMES)
    checks = {
        "q011iu_two_hundred_thirty_three_prior_artifacts_and_helpers_reproduce": bool(
            prior["passed"]
            and prior["artifact_count"] == 233
            and prior["direct_digest_count"] == 1_061
            and len(artifacts) == 233
            and all(prior["checks"].values())
        ),
        "q011iu_artifact_and_runner_sha256_match": bool(
            _file_sha256(artifact_path) == Q011IU_ARTIFACT_SHA256
            and _file_sha256(runner_path) == Q011IU_RUNNER_SHA256
            and artifact["runner_source"]["sha256"] == Q011IU_RUNNER_SHA256
        ),
        "q011iu_section_digests_match": digests == Q011IU_DIGESTS,
        "q011iu_valid_interval_inert_outcome_and_boundary_reproduce": bool(
            artifact["study_gate"] == "passed"
            and artifact["refinement_outcome"] == "partition_inert_persistent"
            and artifact["scientific_outcome"] == "not_evaluated"
            and artifact["actual_resonance_outcome"] == "not_established"
            and cycle["failed_validity_order"] == []
            and theorem["individual_partition_is_interval_inert_for_eighty_eighth_q011cb_witness"]
        ...
        "q011iu_parent_partition_and_relations_reproduce": bool(
            fixed["eighty_eighth_parent_witness_selection_audit"]["selected_flat_ordinal"]
            == PARENT_FLAT_ORDINAL
            and fixed["compatible_allocation_count"] == EXPECTED_INDIVIDUAL_WAVE_ALLOCATION_COUNT
            and fixed["compatible_allocation_digest_sha256"] == q011iu.EXPECTED_COMPATIBLE_DIGEST
        ...
        "q011iu_artifact_is_finite_strict_json": bool(
            _all_numeric_values_finite(artifact)
            and _strict_json_serializable(artifact)
            and json.dumps(artifact, allow_nan=False)
        ),
        "one_thousand_sixty_five_direct_digests_are_sealed": (
            prior["direct_digest_count"] + len(digests) == 1_065
        ),
    }
    artifacts["q011iu"] = artifact
    return (
        {
            "prior_q011iu_sealed_input_audit": prior,
            "q011iu": {
                "artifact_filename": artifact_path.name,
                "artifact_sha256": _file_sha256(artifact_path),
                "runner_filename": runner_path.name,
                "runner_sha256": _file_sha256(runner_path),
                "digest_names": list(Q011IU_DIGEST_NAMES),
...
def _fixed_phase_input_audit(
    ...
    fixed, _lookup, wave_compatible, _parent = q011iu._fixed_individual_input_audit(artifacts)
    stored = artifacts["q011iu"]["cycle"]
    ...
    checks = {
        "q011iu_fixed_parent_replays_and_stored_interval_partition_is_inert": bool(
    ...
    audit = {
        ...
        "q011iu_compatible_wave_allocation_count": len(wave_compatible),
        "q011iu_compatible_wave_allocation_digest_sha256": fixed[
...
def _component_wave_counts(individual_counts: tuple[int, ...]) -> tuple[int, ...]:
    if len(individual_counts) != 10:
        raise ValueError("Q011iv requires ten Q011iu individual counts")
...
def _allocation_inventory(
    ...
    audit = {
        ...
        "allocation_protocol_adapter": {
            ...
            "ordinal_eighty_seven_totals": [1, 12, 9, 5, 7, 0],
...
def _phase_product_audit(
    ...
    replacements = {
        ...
        "PARENT_FLAT_ORDINAL": PARENT_FLAT_ORDINAL,
        "_q011ih_framed_record_digest": _q011iv_framed_record_digest,
        "_q011ih_exact_fraction_sequence_sha256": (_q011iv_exact_fraction_sequence_sha256),
    }
    try:
        ...
        for name, value in _Q011IH_PROTOCOL_BASELINE.items():
            setattr(q011ih, name, value)
    audit["comparison_stream_domain"] = "q011iv-component-safe-phase-comparisons-v1"
    return audit


def _registered_parameters() -> dict[str, Any]:
    return {
        "protocol": "q011iv-eighty-eighth-component-safe-phase-v1",
        "degree": DEGREE,
        "parent_flat_ordinal": PARENT_FLAT_ORDINAL,
        "output_block": OUTPUT_BLOCK,
        "target_identifier": TARGET_IDENTIFIER,
        ...
        "comparison_stream_domain": "q011iv-component-safe-phase-comparisons-v1",
        "complex_margin_digest_domain": "q011iv-complex-margin-expression-v1",
        "q011iv_allocation_enumerator": {
            "source_runner_sha256": _file_sha256(Path(__file__).resolve()),
            "component_wave_records_replace_inherited_wave_records": True,
            "ordinal_eighty_seven_totals": [1, 12, 9, 5, 7, 0],
            "inactive_center_149_pair_retained": True,
            "protocol_globals_modified": False,
        },
...
def run_degree_thirty_four_eighty_eighth_component_safe_phase_audit() -> dict[str, Any]:
    ...
    validity_gates = {
        "q011iu_and_all_prior_proof_objects_are_sealed": {
            "passed": sealed["passed"],
            "threshold": "234 artifacts and 1065 direct digests reproduce",
            "value": sealed["checks"],
        },
        "q011iu_parent_partition_and_interval_inert_result_replay": {
            "passed": phase_input["checks"][
                "q011iu_fixed_parent_replays_and_stored_interval_partition_is_inert"
            ],
            "threshold": "ordinal 87, 701 individual wave allocations and inert result replay",
            "value": phase_input["q011iu_compatible_wave_allocation_digest_sha256"],
        },
        ...
        "strict_stream_section_digests_runner_and_protocol_provenance_reproduce": {
            "passed": bool(
                ...
                and runner["filename"]
                == "q011iv_degree34_eighty_eighth_component_safe_phase_discs.py"
    ...
    diagnostic_gates = {
        "only_the_registered_eighty_eighth_q011cb_witness_is_refined": {
            "passed": bool(
            ...
            "threshold": "ordinal 87 only, one target and no other overlap",
    ...
    cycle = {
        "question": (
            ...
            "strictly separate every complex product in Q011cb flatten ordinal 87?"
        ),
        **input_sections,
    ...
    prior_theorem = artifacts["q011iu"]["cycle"]["theorem_consequence"]
    cycle["theorem_consequence"] = {
        "component_safe_complex_phase_discs_resolve_eighty_eighth_q011cb_witness": resolved,
        "eighty_eighth_q011cb_witness_persists_under_component_safe_phase_discs": persistent,
        "q011an_component_internal_eigenvalue_labels_are_assumed": False,
        "q011iu_ordinal_eighty_seven_interval_inert_diagnostic_is_preserved": True,
    ...
    cycle["claim_boundary"] = (
        ...
        "ordinal 87, its 701-to-701 component-wave quotient and 15278 registered "
        "component-safe phase allocations and target block=7;center=44. It does not "
        "reevaluate ordinals 0 through 86 or classify the later 44712 Q011cb refined "
    ...
    cycle["next_change"] = (
        "Preregister Q011iw to audit the next Q011cb refined overlap in registered order."
        if resolved
        else (
            "Preregister Q011iw to refine only the first unresolved component-safe phase witness."
        )
        if persistent
        else "Repair only the first Q011iv validity failure."
    )
    if not (
        ...
        raise RuntimeError("Q011iv cycle failed strict serialization or digest")
    return cycle


def run_q011iv_study() -> dict[str, Any]:
    started = perf_counter()
    cycle = run_degree_thirty_four_eighty_eighth_component_safe_phase_audit()
    ...
    return {
        ...
        "mathematical_scope": {
            "diagnostic": "eighty-eighth Q011cb witness component-safe complex phase discs",
            "grid": [SIZE, SIZE],
