"""Sealed Q007u exact stagewise-positivity certificate for the larger Q007s tube."""
...
Q007T_ARTIFACT = "q007t_larger_tube_population_positivity.json"
REGISTERED_Q007T_ARTIFACT_SHA256 = (
    "2089d97aa19248cc17689f3e7a01e113540e5afc329ffa5cb3a4c511a43a8529"
)
REGISTERED_Q007T_RUNNER_SHA256 = (
...
def _load_registered_q007t(
    directory: Path,
) -> tuple[dict[str, Any], dict[str, Any]]:
    artifact_path = directory / Q007T_ARTIFACT
    ...
    q007s_input_passed = bool(
        cycle.get("input_artifact", {}).get("passed", False)
    )
    q007s_tube_passed = bool(
        cycle.get("q007s_tube_reuse", {}).get("passed", False)
    )
    record = {
        "filename": Q007T_ARTIFACT,
        "registered_sha256": REGISTERED_Q007T_ARTIFACT_SHA256,
        "sha256": observed_artifact_sha256,
        "sha256_matches": (
            observed_artifact_sha256 == REGISTERED_Q007T_ARTIFACT_SHA256
        ),
        "sha256_newline_normalization": "UTF-8 text with universal newlines",
        ...
        "q007s_input_passed": q007s_input_passed,
        "q007s_tube_reuse_passed": q007s_tube_passed,
        "registered_runner_sha256": REGISTERED_Q007T_RUNNER_SHA256,
        "artifact_runner_sha256": artifact_runner_sha256,
        "observed_runner_sha256": observed_runner_sha256,
        "runner_sha_matches": bool(
            artifact_runner_sha256 == REGISTERED_Q007T_RUNNER_SHA256
            and observed_runner_sha256 == REGISTERED_Q007T_RUNNER_SHA256
        ),
    }
    record["passed"] = bool(
        ...
        and record["validity_gate_count"] == 5
        and record["all_hypothesis_gates_pass"]
        and record["hypothesis_gate_count"] == 3
        and theorem_flags_match
        and q007s_input_passed
        and q007s_tube_passed
...
def run_larger_tube_stagewise_positivity_audit(
    ...
    q007t, input_record = _load_registered_q007t(directory)
    q007t_cycle = q007t["cycle"]
    tube = q007t_cycle["q007s_tube_reuse"]
    q007t_bounds = q007t_cycle["positivity_bounds"]
    ...
    q007t_population_lower = _fraction_from_record(
        q007t_bounds["registered_population_lower"]
    )
    ...
    full_map_lower = q007t_population_lower
    candidate_gates = tube["selected_candidate_gates"]
    forward_invariance = bool(tube["q007s_forward_invariance"])
    tube_reused = bool(
        base_radius == BASE_RADIUS
        and normal_radius == NORMAL_RADIUS
        and q007t_population_lower == minimum_weight - state_radius
    ...
    stage_bounds = {
        ...
        "q007t_input_population_lower": _fraction_record(
            q007t_population_lower
        ),
        ...
        "q007t_full_map_output_population_lower": _fraction_record(
            full_map_lower
        ),
    ...
    tube_reuse = {
        ...
        "q007t_population_lower": _fraction_record(q007t_population_lower),
    ...
    validity_gates = {
        "registered_q007t_input": {
            "passed": input_record["passed"],
            "threshold": (
                "Q007t artifact/runner SHA, source, scope, five validity "
                "gates, three hypothesis gates, three theorem flags, and "
                "transitive Q007s input match"
            ),
        ...
        "registered_q007s_tube_reused": {
            "passed": tube_reuse["passed"],
            "threshold": (
                "Q007t x_*, p_*, r, zeta, all six selected-candidate gates, "
                "and transitive Q007s forward invariance reproduce exactly"
            ),
    ...
    hypothesis_gates = {
        ...
        "all_iterate_stagewise_positive": {
            ...
            "threshold": (
                "Q007s forward invariance reapplies all four strict stage "
    ...
    if not validity_passed:
        ...
        classification = "registered Q007u larger-tube stagewise-positivity audit invalid"
    elif hypotheses_passed:
        outcome = "accepted"
        classification = (
            "registered Q007s larger tube is population-positive at every exact BGK, "
            "streaming, and filter stage"
        )
    else:
        outcome = "not_certified"
        classification = (
            "registered Q007s larger tube did not certify exact stagewise population "
            "positivity"
        )
    ...
    return {
        "question": (
            ...
            "stage population-positive on the registered Q007s larger tube?"
        ),
        ...
        "claim_boundary": (
            ...
            "fixed Q007s selected tube at every iterate. It does not enclose every "
            "IEEE-754 intermediate operation or certify entropy, monotonicity, "
            "a maximum principle, a continuous-optimum tube, a global basin, grid-"
        ...
        "preserved_prior_outcomes": {
            ...
            "q007r_original_tube_stagewise_acceptance_changed": False,
            "q007c1_finite_amplitude_rejection_changed": False,
            "q007d_euclidean_rejection_changed": False,
            "q008c_tt_rejection_changed": False,
        },
        "next_change": (
            "If accepted, keep this finite-grid larger tube fixed and treat "
            "IEEE-754 roundoff or further radius optimization as separate "
            "preregistered gates."
        ),
    }
...
def run_q007u_study(
    ...
    cycle = run_larger_tube_stagewise_positivity_audit(artifact_directory)
    return {
        "schema_version": 1,
