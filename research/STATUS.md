...
17³/33³は計164,320組・385,840列を完了し、candidate不合格0。
H3共役誤差最大はそれぞれ`1.11479e-12 / 1.36351e-11`で、登録上限`1e-8`以内。
保存後の全行・全fiber監査、独立324組との一致、最悪例のfresh計算・物理forcing再計算も通過した。
保存後監査は両格子4件ずつ、計8テストを通過した。主計算は65³へ進んでいる。
65³と最終照合が未完了なので、三格子の通過判定にはしない。
...
| 進行中の主課題 | Q012f2: 独立972組のGMP replayと17³/33³の計164,320組・385,840列の保存後監査を完了。65³を検証中。未完了の格子を総合受理へ含めない |
