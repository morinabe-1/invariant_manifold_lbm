"""Q011ng individual-disc partition audit for Q011cb flatten ordinal 145."""
...
EXPECTED_CLASS_TOTALS = (1, 12, 8, 1, 5, 1, 6)
EXPECTED_SOURCE_COUNTS = (1, 0, 12, 0, 8, 0, 1, 0, 0, 5, 0, 1, 0, 6)
...
EXPECTED_OCCUPIED_RECORD_DIGEST = "02ee84a4a0cb2874c80806d23cb2854849fedcee82c2d429d5ee0a5867124f0f"
EXPECTED_IDENTIFIER_ORDER_DIGEST = (
    "c90ea70931e0bb67733cb9179566e166baf2a67756933394db785fb4f941276a"
)
EXPECTED_ALLOCATION_DIGEST = "1753ef1215b076fbb1244089cc474c534c8ffad41cb73970dc9a2976681bcc97"
EXPECTED_COMPATIBLE_DIGEST = "7d5ef7115319e11ebac05f47018cbb01bec876ae973f25f7cce2a9fa68886c13"

EXPECTED_PARENT_WAVE_MULTIPLICITY = 2_185
EXPECTED_PARENT_BLOCK_ZERO_MULTIPLICITY = 0
EXPECTED_PARENT_INTERSECTION_WIDTH_HEX = "0x1.4b3337a9b7485p-31"
EXPECTED_PARENT_CENTER_RELATION = "target_below_product"
EXPECTED_PARENT_CENTER_GAP_HEX = "0x1.32d753b54effap-28"
EXPECTED_PARENT_WITNESS_DIGEST = "ea16c92218cb94ff35af07685ee79c048a03a352cdcae5475953b82d6a15b9c1"
EXPECTED_PARENT_PRODUCT_DIGEST = "561b4de56343bd91f4350bee180b9c01bced2aba94d6c9fdb1c38c68244941e5"
...
Q011NF_ARTIFACT_SHA256 = "ea6027776463376ed2fc67389c1f9a925b5494047ae850c700d37a1066135f3a"
Q011NF_RUNNER_SHA256 = "95106f29b0763f0ed14eeb4f29edc6216f77d2dcae75ce2daca95ae124208651"
Q011NF_DIGEST_NAMES = (
    "input_digest_sha256",
...
Q011NF_DIGESTS = (
    "80cbef9d315ab6ab132f7feb74c28be3b39356e22a0c0b7691d638cbf67561dc",
    ...
    "0ff5f8827cd43347baa3f12635b58d1f996dd37bf7588c037a0f6043f5556956",
)
EXPECTED_Q011NF_STREAM_DIGEST = "b742544a22f8502dc0bc49df1c97e3f822002636d4009ab63c3b16fd8bbb8e5d"
EXPECTED_ORDINAL_ONE_HUNDRED_FORTY_FOUR_RESOLUTION_DIGEST = (
    "e56c1012985dec3148f724f74f3a19f365a0766d6fbddcce1448ea1d4cbaf8cf"
)
ALLOCATION_STREAM_DOMAIN = "q011ng-individual-partition-allocation-records-v1"

INERT_CLASSIFICATION = (
    "the individual-disc partition is interval-inert for the one-hundred-forty-sixth "
    "Q011cb witness"
)
RESOLVED_CLASSIFICATION = (
    "the one-hundred-forty-sixth Q011cb witness is resolved by individual partition"
)
EFFECTIVE_PERSISTENT_CLASSIFICATION = (
    "the individual-disc partition changes intervals but the one-hundred-forty-sixth "
    "Q011cb witness persists"
)
INCONCLUSIVE_CLASSIFICATION = "the Q011ng individual-disc partition audit is inconclusive"
...
def _protocol_globals_are_restored() -> bool:
    return bool(
        ...
        and q011nf._protocol_globals_are_restored()
    )
...
def _sealed_input_audit_cached() -> tuple[
    ...
    prior, artifacts = q011nf._sealed_input_audit()
    ...
    digests = tuple(cycle[name] for name in Q011NF_DIGEST_NAMES)
    checks = {
        "q011nf_three_hundred_forty_eight_prior_artifacts_and_helpers_reproduce": bool(
            prior["passed"]
            and prior["artifact_count"] == 348
            and prior["direct_digest_count"] == 1_578
            and len(artifacts) == 348
            and all(prior["checks"].values())
        ),
        "q011nf_artifact_and_runner_sha256_match": bool(
            _file_sha256(artifact_path) == Q011NF_ARTIFACT_SHA256
            and _file_sha256(runner_path) == Q011NF_RUNNER_SHA256
            and artifact["runner_source"]["sha256"] == Q011NF_RUNNER_SHA256
        ),
        "q011nf_section_digests_match": digests == Q011NF_DIGESTS,
        "q011nf_valid_phase_resolution_and_boundary_reproduce": bool(
            ...
            and theorem[
                "q011ne_ordinal_one_hundred_forty_four_interval_inert_diagnostic_is_preserved"
            ]
            and all(
                value
        ...
        "q011nf_registered_ordinal_one_hundred_forty_four_resolution_reproduces": bool(
        ...
        "q011nf_artifact_is_finite_strict_json": bool(
            _all_numeric_values_finite(artifact)
            and _strict_json_serializable(artifact)
            and json.dumps(artifact, allow_nan=False)
        ),
        "one_thousand_five_hundred_eighty_three_direct_digests_are_sealed": (
            prior["direct_digest_count"] + len(digests) == 1_583
        ),
    }
    artifacts["q011nf"] = artifact
    return (
        {
            "prior_q011nf_sealed_input_audit": prior,
            "q011nf": {
                "artifact_filename": artifact_path.name,
                "artifact_sha256": _file_sha256(artifact_path),
                "runner_filename": runner_path.name,
                "runner_sha256": _file_sha256(runner_path),
                "digest_names": list(Q011NF_DIGEST_NAMES),
...
def _fixed_individual_input_audit(
    ...
    q011nf_cycle = artifacts["q011nf"]["cycle"]
    q011nf_comparison = q011nf_cycle["complex_phase_product_disc_audit"]
    selection["checks"][
        "ordinals_zero_through_one_hundred_forty_four_are_sealed_phase_resolutions"
    ] = bool(
        previous_check
        and q011nf_cycle["theorem_consequence"][
            "component_safe_complex_phase_discs_resolve_one_hundred_forty_fifth_q011cb_witness"
        ]
        and q011nf_comparison["global_minimum_margin_witness"][
            "witness_digest_sha256"
        ]
        == EXPECTED_ORDINAL_ONE_HUNDRED_FORTY_FOUR_RESOLUTION_DIGEST
    )
    selection["checks"][
        "registered_ordinal_one_hundred_forty_five_parent_witness_reproduces"
    ] = registered_check
    ...
    selection["previous_phase_resolved_ordinals"] = list(range(145))
    selection["ordinal_one_hundred_forty_four_resolution_digest_sha256"] = (
        EXPECTED_ORDINAL_ONE_HUNDRED_FORTY_FOUR_RESOLUTION_DIGEST
    )
    selection["one_hundred_forty_sixth_parent_witness"] = selection.pop(
        "third_parent_witness"
    )
    selection["one_hundred_forty_sixth_parent_witness_digest_sha256"] = (
        selection.pop("third_parent_witness_digest_sha256")
    )
    selection["passed"] = all(selection["checks"].values())
    fixed["one_hundred_forty_sixth_parent_witness_selection_audit"] = selection
    fixed["checks"].pop("registered_third_parent_selection_reproduces")
    fixed["checks"][
        "registered_one_hundred_forty_sixth_parent_selection_reproduces"
    ] = selection["passed"]
...
def _interval_record(lower: Fraction, upper: Fraction) -> dict[str, Any]:
    if not lower <= upper:
        raise RuntimeError("Q011ng constructed an unordered interval")
    return {
...
def run_degree_thirty_four_one_hundred_forty_sixth_individual_partition_audit() -> dict[str, Any]:
    ...
    selection = fixed["one_hundred_forty_sixth_parent_witness_selection_audit"]
    validity_gates = {
        "q011nf_and_all_prior_proof_objects_are_sealed": {
            "passed": sealed["passed"],
            "threshold": "349 artifacts and 1583 direct digests reproduce",
            "value": sealed["checks"],
        },
        "registered_one_hundred_forty_sixth_parent_witness_reproduces": {
            "passed": selection["passed"],
            "threshold": "ordinal 145, class counts, 2185 multiplicity and exact witness",
            "value": selection[
                "one_hundred_forty_sixth_parent_witness_digest_sha256"
            ],
        },
        ...
        "all_class_total_degree_and_output_constraints_close": {
            ...
            "threshold": "2185 allocations, fixed class totals, degree 34 and output block 7",
        ...
        "strict_section_digests_runner_and_protocol_provenance_reproduce": {
            "passed": bool(
                ...
                == 64
                and runner["filename"]
                == "q011ng_degree34_one_hundred_forty_sixth_individual_partition_audit.py"
    ...
    diagnostic_gates = {
        "only_the_registered_one_hundred_forty_sixth_q011cb_signature_is_refined": {
            "passed": bool(
            ...
            "threshold": "ordinal 145 only, one target and no other aggregate",
    ...
    cycle = {
        "question": (
            "Does splitting Q011cb flatten ordinal 145 into fourteen singleton "
    ...
    prior_theorem = artifacts["q011nf"]["cycle"]["theorem_consequence"]
    cycle["theorem_consequence"] = {
        "individual_partition_is_interval_inert_for_one_hundred_forty_sixth_q011cb_witness": inert,
        "one_hundred_forty_sixth_q011cb_witness_is_resolved_by_individual_partition": resolved,
        "individual_partition_changes_intervals_but_one_hundred_forty_sixth_q011cb_witness_persists": (
            effective_persistent
        ),
        "q011nf_ordinal_one_hundred_forty_four_phase_resolution_is_preserved": True,
        **{
            name: value
    ...
    cycle["claim_boundary"] = (
        "This diagnostic concerns only Q011cb flatten ordinal 145, its 2185 "
        ...
        "It uses ordinals 0 through 144 only as sealed selection boundaries and does "
        "not reevaluate them. It does not evaluate complex phase, the later 44654 "
    ...
    cycle["next_change"] = (
        "Preregister Q011nh to expand only the registered 2185 wave allocations into component-safe complex phase discs."
        if inert
        else "Preregister Q011nh to audit flatten ordinal 146 in registered order."
        if resolved
        else (
            "Preregister Q011nh to refine only the first remaining individual-allocation overlap by component-safe complex phase."
        )
        if effective_persistent
        else "Repair only the first Q011ng validity failure."
    )
    if not (
        ...
        raise RuntimeError("Q011ng cycle failed strict serialization or digest")
    return cycle


def run_q011ng_study() -> dict[str, Any]:
    cycle = run_degree_thirty_four_one_hundred_forty_sixth_individual_partition_audit()
    ...
    return {
        ...
        "mathematical_scope": {
            "diagnostic": (
                "one-hundred-forty-sixth Q011cb witness individual-disc partition"
            ),
            "grid": [SIZE, SIZE],
