"""Q011nk individual-disc partition audit for Q011cb flatten ordinal 147."""
...
EXPECTED_CLASS_TOTALS = (1, 12, 8, 1, 5, 3, 4)
EXPECTED_SOURCE_COUNTS = (1, 0, 12, 0, 8, 0, 1, 0, 0, 5, 0, 3, 0, 4)
...
EXPECTED_OCCUPIED_RECORD_DIGEST = "54e40e48fd7c6a03ada27ae94da98f100f767334b99d89e917ef4fae8882d3b1"
EXPECTED_IDENTIFIER_ORDER_DIGEST = (
    "c90ea70931e0bb67733cb9179566e166baf2a67756933394db785fb4f941276a"
)
EXPECTED_ALLOCATION_DIGEST = "546f9446bd899279ab6cd95aa7b43e1e4f96746eb68f9468de3f0f71ed6a9ed6"
EXPECTED_COMPATIBLE_DIGEST = "730519a9300dbed5e613424b0544a126d5c49ddc91729f4e5073c34b232b418b"

EXPECTED_PARENT_WAVE_MULTIPLICITY = 3_104
EXPECTED_PARENT_BLOCK_ZERO_MULTIPLICITY = 0
EXPECTED_PARENT_INTERSECTION_WIDTH_HEX = "0x1.4b331c186bae0p-31"
EXPECTED_PARENT_CENTER_RELATION = "target_below_product"
EXPECTED_PARENT_CENTER_GAP_HEX = "0x1.32d74efddc2cdp-28"
EXPECTED_PARENT_WITNESS_DIGEST = "2ec82d9656d8452142904e1487d57dc37cdf284cdc578e6c3dc3b483e402cbdc"
EXPECTED_PARENT_PRODUCT_DIGEST = "7d75ae36242d47eff76b8d1109d40999a707aeb8a10e635bcd8c9c902d7b00c3"
EXPECTED_PARENT_CENTER_PRODUCT_DIGEST = (
    "7141f10c6c1361870f459b625bd81b7f743d3e1afbb263bd6635d1cdc72801b2"
)
...
EXPECTED_PARENT_INTERSECTION_DIGEST = (
    "672ec6bfeadc174fa19c2bef2824861d158fa789c1691fe8c2430e69d222afdf"
)

Q011NJ_ARTIFACT_SHA256 = "8037fe32e6a9be3f22d3ea02ca1db4aafc7edc67ab6b625865d3ce643784b239"
Q011NJ_RUNNER_SHA256 = "19b7791cb16c4d318026934cd5f19dcc51f533849e4a361e5d59001972ec668b"
Q011NJ_DIGEST_NAMES = (
    "input_digest_sha256",
...
Q011NJ_DIGESTS = (
    "1a87e706aca2da16fa81510ae1feef263006c6716553d6ba27ff26865e748042",
    ...
    "4710adae6f73c2cc40a12e415933e66264366236fc54ff2c3f463ac6a3e50ac1",
)
EXPECTED_Q011NJ_STREAM_DIGEST = "24ee9aa9a109dea45cd16ae5cee2ce4f2b3ee9221187851d5b8974f23b03451c"
EXPECTED_ORDINAL_ONE_HUNDRED_FORTY_SIX_RESOLUTION_DIGEST = (
    "205aeac7dcb616fcd85ad87e4567d590f9b0b906422e3fd814ad9b05a08f1281"
)
ALLOCATION_STREAM_DOMAIN = "q011nk-individual-partition-allocation-records-v1"

INERT_CLASSIFICATION = (
    "the individual-disc partition is interval-inert for the one-hundred-forty-eighth "
    "Q011cb witness"
)
RESOLVED_CLASSIFICATION = (
    "the one-hundred-forty-eighth Q011cb witness is resolved by individual partition"
)
EFFECTIVE_PERSISTENT_CLASSIFICATION = (
    "the individual-disc partition changes intervals but the one-hundred-forty-eighth "
    "Q011cb witness persists"
)
INCONCLUSIVE_CLASSIFICATION = "the Q011nk individual-disc partition audit is inconclusive"
...
def _protocol_globals_are_restored() -> bool:
    return bool(
        ...
        and q011nj._protocol_globals_are_restored()
    )
...
def _sealed_input_audit_cached() -> tuple[
    ...
    prior, artifacts = q011nj._sealed_input_audit()
    ...
    digests = tuple(cycle[name] for name in Q011NJ_DIGEST_NAMES)
    checks = {
        "q011nj_three_hundred_fifty_two_prior_artifacts_and_helpers_reproduce": bool(
            prior["passed"]
            and prior["artifact_count"] == 352
            and prior["direct_digest_count"] == 1_596
            and len(artifacts) == 352
            and all(prior["checks"].values())
        ),
        "q011nj_artifact_and_runner_sha256_match": bool(
            _file_sha256(artifact_path) == Q011NJ_ARTIFACT_SHA256
            and _file_sha256(runner_path) == Q011NJ_RUNNER_SHA256
            and artifact["runner_source"]["sha256"] == Q011NJ_RUNNER_SHA256
        ),
        "q011nj_section_digests_match": digests == Q011NJ_DIGESTS,
        "q011nj_valid_phase_resolution_and_boundary_reproduce": bool(
        ...
        "q011nj_registered_ordinal_one_hundred_forty_six_resolution_reproduces": bool(
        ...
        "q011nj_artifact_is_finite_strict_json": bool(
            _all_numeric_values_finite(artifact)
            and _strict_json_serializable(artifact)
            and json.dumps(artifact, allow_nan=False)
        ),
        "one_thousand_six_hundred_one_direct_digests_are_sealed": (
            prior["direct_digest_count"] + len(digests) == 1_601
        ),
    }
    artifacts["q011nj"] = artifact
    return (
        {
            "prior_q011nj_sealed_input_audit": prior,
            "q011nj": {
                "artifact_filename": artifact_path.name,
                "artifact_sha256": _file_sha256(artifact_path),
                "runner_filename": runner_path.name,
                "runner_sha256": _file_sha256(runner_path),
                "digest_names": list(Q011NJ_DIGEST_NAMES),
...
def _fixed_individual_input_audit(
    ...
    q011nj_cycle = artifacts["q011nj"]["cycle"]
    q011nj_comparison = q011nj_cycle["complex_phase_product_disc_audit"]
    selection["checks"][
        "ordinals_zero_through_one_hundred_forty_six_are_sealed_phase_resolutions"
    ] = bool(
        previous_check
        and q011nj_cycle["theorem_consequence"][
            "component_safe_complex_phase_discs_resolve_one_hundred_forty_seventh_q011cb_witness"
        ]
        and q011nj_comparison["global_minimum_margin_witness"][
            "witness_digest_sha256"
        ]
        == EXPECTED_ORDINAL_ONE_HUNDRED_FORTY_SIX_RESOLUTION_DIGEST
    )
    selection["checks"][
        "registered_ordinal_one_hundred_forty_seven_parent_witness_reproduces"
    ] = registered_check
    ...
    selection["previous_phase_resolved_ordinals"] = list(range(147))
    selection["ordinal_one_hundred_forty_six_resolution_digest_sha256"] = (
        EXPECTED_ORDINAL_ONE_HUNDRED_FORTY_SIX_RESOLUTION_DIGEST
    )
    selection["one_hundred_forty_eighth_parent_witness"] = selection.pop(
        "third_parent_witness"
    )
    selection["one_hundred_forty_eighth_parent_witness_digest_sha256"] = (
        selection.pop("third_parent_witness_digest_sha256")
    )
    selection["passed"] = all(selection["checks"].values())
    fixed["one_hundred_forty_eighth_parent_witness_selection_audit"] = selection
    fixed["checks"].pop("registered_third_parent_selection_reproduces")
    fixed["checks"][
        "registered_one_hundred_forty_eighth_parent_selection_reproduces"
    ] = selection["passed"]
...
def _interval_record(lower: Fraction, upper: Fraction) -> dict[str, Any]:
    if not lower <= upper:
        raise RuntimeError("Q011nk constructed an unordered interval")
    return {
...
def run_degree_thirty_four_one_hundred_forty_eighth_individual_partition_audit() -> dict[str, Any]:
    ...
    validity_gates = {
        "q011nj_and_all_prior_proof_objects_are_sealed": {
            "passed": sealed["passed"],
            "threshold": "353 artifacts and 1601 direct digests reproduce",
            "value": sealed["checks"],
        },
        "registered_one_hundred_forty_eighth_parent_witness_reproduces": {
            "passed": selection["passed"],
            "threshold": "ordinal 147, class counts, 3104 multiplicity and exact witness",
            "value": selection[
                "one_hundred_forty_eighth_parent_witness_digest_sha256"
            ],
        },
        ...
        "all_class_total_degree_and_output_constraints_close": {
            ...
            "threshold": "3104 allocations, fixed class totals, degree 34 and output block 7",
        ...
        "strict_section_digests_runner_and_protocol_provenance_reproduce": {
            "passed": bool(
                ...
                == 64
                and runner["filename"]
                == "q011nk_degree34_one_hundred_forty_eighth_individual_partition_audit.py"
    ...
    diagnostic_gates = {
        "only_the_registered_one_hundred_forty_eighth_q011cb_signature_is_refined": {
            "passed": bool(
            ...
            "threshold": "ordinal 147 only, one target and no other aggregate",
    ...
    cycle = {
        "question": (
            "Does splitting Q011cb flatten ordinal 147 into fourteen singleton "
    ...
    prior_theorem = artifacts["q011nj"]["cycle"]["theorem_consequence"]
    cycle["theorem_consequence"] = {
        "individual_partition_is_interval_inert_for_one_hundred_forty_eighth_q011cb_witness": inert,
        "one_hundred_forty_eighth_q011cb_witness_is_resolved_by_individual_partition": resolved,
        "individual_partition_changes_intervals_but_one_hundred_forty_eighth_q011cb_witness_persists": (
            effective_persistent
        ),
        "q011nj_ordinal_one_hundred_forty_six_phase_resolution_is_preserved": True,
        **{
            name: value
    ...
    cycle["claim_boundary"] = (
        "This diagnostic concerns only Q011cb flatten ordinal 147, its 3104 "
        ...
        "It uses ordinals 0 through 146 only as sealed selection boundaries and does "
        "not reevaluate them. It does not evaluate complex phase, the later 44652 "
    ...
    cycle["next_change"] = (
        "Preregister Q011nl to expand only the registered 3104 wave allocations into component-safe complex phase discs."
        if inert
        else "Preregister Q011nl to audit flatten ordinal 148 in registered order."
        if resolved
        else (
            "Preregister Q011nl to refine only the first remaining individual-allocation overlap by component-safe complex phase."
        )
        if effective_persistent
        else "Repair only the first Q011nk validity failure."
    )
    if not (
        ...
        raise RuntimeError("Q011nk cycle failed strict serialization or digest")
    return cycle


def run_q011nk_study() -> dict[str, Any]:
    cycle = run_degree_thirty_four_one_hundred_forty_eighth_individual_partition_audit()
    ...
    return {
        ...
        "mathematical_scope": {
            "diagnostic": (
                "one-hundred-forty-eighth Q011cb witness individual-disc partition"
            ),
            "grid": [SIZE, SIZE],
