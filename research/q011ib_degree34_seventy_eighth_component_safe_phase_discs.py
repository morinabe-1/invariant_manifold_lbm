"""Q011ib component-safe complex phase discs for Q011cb flatten ordinal seventy-seven."""
...
EXPECTED_INDIVIDUAL_WAVE_ALLOCATION_COUNT = 852
...
EXPECTED_BRIDGE_FIBER_HISTOGRAM = {1: 852}
EXPECTED_BRIDGE_RECORD_DIGEST = "2c7c2ad37699871c530f841556e84bf7037e60a16be3d13ce7f730b1aa1728f6"
EXPECTED_PAIRED_RECORD_DIGEST = "b68aa2ede11c94b3d0a003f3eddd6b5cdc6ed146b309271e962fbda4f395703b"

Q011IA_ARTIFACT_SHA256 = "d1e0d5456e813e608b8815d6fee533411590e1c2f59aa5bbd7ccb872c69fd3b3"
Q011IA_RUNNER_SHA256 = "b6b35f36170330a1f2ab718dca596d13be164bec1eba5c4607163152c21b1b4c"
Q011IA_DIGEST_NAMES = (
    "input_digest_sha256",
...
EXPECTED_Q011IA_ALLOCATION_RECORD_DIGEST = (
    "af16dbd59d70ca2723704f53387d77416e4a394b06546c9f3513a338d0894881"
)

RESOLVED_CLASSIFICATION = "the component-safe complex phase discs resolve the seventy-eighth Q011cb persistent refined witness"
PERSISTENT_CLASSIFICATION = (
    "the seventy-eighth Q011cb persistent refined witness persists under component-safe "
    "complex phase discs"
)
INCONCLUSIVE_CLASSIFICATION = "the Q011ib component-safe phase-disc audit is inconclusive"
...
def _q011ib_framed_record_digest(domain: str) -> Any:
    if domain != "q011ch-component-safe-phase-comparisons-v1":
        raise ValueError(f"unexpected inherited comparison domain: {domain}")
    return q011cx._BASE_FRAMED_RECORD_DIGEST("q011ib-component-safe-phase-comparisons-v1")


def _q011ib_exact_fraction_sequence_sha256(
    domain: bytes,
    values: tuple[Fraction, ...],
) -> str:
    if domain == b"q011ch-complex-margin-expression-v1":
        domain = b"q011ib-complex-margin-expression-v1"
    return q011cx._BASE_EXACT_FRACTION_SEQUENCE_SHA256(domain, values)


def _q011ib_power_tables(
...
def _adapted_q011cx_globals_are_restored() -> bool:
    return bool(
        ...
        and (
            q011ia.q011da._Q011CY_PROTOCOL_OVERRIDE is q011ia._Q011DA_PROTOCOL_BASELINE
            or q011ia.q011da._Q011CY_PROTOCOL_OVERRIDE is q011ia._Q011DA_PROTOCOL_OVERRIDE
        )
        and (
            q011ia.q011da.q011cy._Q011CW_PROTOCOL_OVERRIDE
            is q011ia.q011da._Q011CY_PROTOCOL_BASELINE
            or q011ia.q011da.q011cy._Q011CW_PROTOCOL_OVERRIDE is q011ia._Q011DA_PROTOCOL_OVERRIDE
        )
        and q011ia.q011da.q011cy.q011cw._Q011CK_PROTOCOL_OVERRIDE
        is q011ia.q011da.q011cy._Q011CW_PROTOCOL_BASELINE
        and q011ia.q011da.q011cy.q011cw._protocol_globals_are_restored()
    )


def _adapted_q011ia_globals_are_restored() -> bool:
...
def _adapted_q011cx_protocol_overrides() -> dict[str, Any]:
    ...
    overrides["_power_tables"] = _q011ib_power_tables
    return overrides
...
def _q011cx_protocol_overrides() -> dict[str, Any]:
    return {
        ...
        "_q011cx_framed_record_digest": _q011ib_framed_record_digest,
        "_q011cx_exact_fraction_sequence_sha256": (_q011ib_exact_fraction_sequence_sha256),
...
def _q011cx_protocol_context() -> Iterator[None]:
    ...
    original_q011ia_restore = q011ia._protocol_globals_are_restored
    original_q011da_restore = q011ia.q011da._protocol_globals_are_restored
    try:
        for name, value in overrides.items():
            setattr(q011cx, name, value)
        q011ia._protocol_globals_are_restored = _adapted_q011ia_globals_are_restored
        q011ia.q011da._protocol_globals_are_restored = _adapted_q011da_globals_are_restored
        yield
    finally:
        q011ia.q011da._protocol_globals_are_restored = original_q011da_restore
        q011ia._protocol_globals_are_restored = original_q011ia_restore
...
def _protocol_globals_are_restored() -> bool:
    return bool(
        ...
        and q011ia._protocol_globals_are_restored()
        and q011cj._protocol_globals_are_restored()
    )


def _sealed_input_audit() -> tuple[dict[str, Any], dict[str, dict[str, Any]]]:
    prior, artifacts = q011ia._sealed_input_audit()
    ...
    digests = tuple(cycle[name] for name in Q011IA_DIGEST_NAMES)
    checks = {
        "q011ia_two_hundred_thirteen_prior_artifacts_and_helpers_reproduce": bool(
            prior["passed"]
            and prior["artifact_count"] == 213
            and prior["direct_digest_count"] == 971
            and len(artifacts) == 213
            and all(prior["checks"].values())
        ),
        "q011ia_artifact_and_runner_sha256_match": bool(
            _file_sha256(artifact_path) == Q011IA_ARTIFACT_SHA256
            and _file_sha256(runner_path) == Q011IA_RUNNER_SHA256
            and artifact["runner_source"]["sha256"] == Q011IA_RUNNER_SHA256
        ),
        "q011ia_section_digests_match": digests == Q011IA_DIGESTS,
        "q011ia_valid_interval_inert_outcome_and_boundary_reproduce": bool(
            artifact["study_gate"] == "passed"
            and artifact["refinement_outcome"] == "partition_inert_persistent"
            and artifact["scientific_outcome"] == "not_evaluated"
            and artifact["actual_resonance_outcome"] == "not_established"
            and cycle["failed_validity_order"] == []
            and theorem["individual_partition_is_interval_inert_for_seventy_eighth_q011cb_witness"]
        ...
        "q011ia_parent_partition_and_relations_reproduce": bool(
            fixed["seventy_eighth_parent_witness_selection_audit"]["selected_flat_ordinal"]
            == PARENT_FLAT_ORDINAL
            and fixed["compatible_allocation_count"] == EXPECTED_INDIVIDUAL_WAVE_ALLOCATION_COUNT
            and fixed["compatible_allocation_digest_sha256"] == q011ia.EXPECTED_COMPATIBLE_DIGEST
        ...
        "q011ia_artifact_is_finite_strict_json": bool(
            _all_numeric_values_finite(artifact)
            and _strict_json_serializable(artifact)
            and json.dumps(artifact, allow_nan=False)
        ),
        "nine_hundred_seventy_five_direct_digests_are_sealed": (
            prior["direct_digest_count"] + len(digests) == 975
        ),
    }
    artifacts["q011ia"] = artifact
    return (
        {
            "prior_q011ia_sealed_input_audit": prior,
            "q011ia": {
                "artifact_filename": artifact_path.name,
                "artifact_sha256": _file_sha256(artifact_path),
                "runner_filename": runner_path.name,
                "runner_sha256": _file_sha256(runner_path),
                "digest_names": list(Q011IA_DIGEST_NAMES),
...
def _fixed_phase_input_audit(
    ...
    adapted["q011cw"] = artifacts["q011ia"]
    with _q011cx_protocol_context():
        audit, sources, target, wave_compatible = q011cx._fixed_phase_input_audit(adapted)
    audit["checks"]["q011ia_fixed_parent_and_interval_partition_replay_bitwise"] = audit[
        "checks"
    ].pop("q011cw_fixed_parent_and_interval_partition_replay_bitwise")
    audit["q011ia_compatible_wave_allocation_count"] = audit.pop(
        "q011cw_compatible_wave_allocation_count"
    )
    audit["q011ia_compatible_wave_allocation_digest_sha256"] = audit.pop(
...
def _component_wave_counts(individual_counts: tuple[int, ...]) -> tuple[int, ...]:
    if len(individual_counts) != 10:
        raise ValueError("Q011ib requires ten Q011ia individual counts")
...
def _allocation_inventory(
    ...
    audit = {
        ...
        "allocation_protocol_adapter": {
            ...
            "ordinal_seventy_seven_totals": [13, 9, 5, 5, 2],
...
def _phase_product_audit(
    ...
    comparison["comparison_stream_domain"] = "q011ib-component-safe-phase-comparisons-v1"
...
def _registered_parameters() -> dict[str, Any]:
    ...
    registered["q011ib_allocation_enumerator"] = {
        "source_runner_sha256": _file_sha256(Path(__file__).resolve()),
...
def run_degree_thirty_four_seventy_eighth_component_safe_phase_audit() -> dict[str, Any]:
    ...
    validity_gates = {
        "q011ia_and_all_prior_proof_objects_are_sealed": {
            "passed": sealed["passed"],
            "threshold": "214 artifacts and 975 direct digests reproduce",
            "value": sealed["checks"],
        },
        "q011ia_parent_partition_and_interval_inert_result_replay": {
            "passed": phase_input["checks"][
                "q011ia_fixed_parent_and_interval_partition_replay_bitwise"
            ],
            "threshold": "ordinal 77, 852 individual wave allocations and inert result replay",
            "value": phase_input["q011ia_compatible_wave_allocation_digest_sha256"],
        },
        ...
        "component_safe_allocation_and_component_quotient_reproduce": {
            ...
            "threshold": (
                "852 individual waves quotient to 852 component waves; "
        ...
        "strict_stream_section_digests_runner_and_protocol_provenance_reproduce": {
            "passed": bool(
                ...
                and runner["filename"]
                == "q011ib_degree34_seventy_eighth_component_safe_phase_discs.py"
    ...
    diagnostic_gates = {
        "only_the_registered_seventy_eighth_q011cb_witness_is_refined": {
            "passed": bool(
            ...
            "threshold": "ordinal 77 only, one target and no other overlap",
    ...
    cycle = {
        "question": (
            ...
            "strictly separate every complex product in Q011cb flatten ordinal 77?"
        ),
        **input_sections,
    ...
    cycle["theorem_consequence"] = {
        "component_safe_complex_phase_discs_resolve_seventy_eighth_q011cb_witness": resolved,
        "seventy_eighth_q011cb_witness_persists_under_component_safe_phase_discs": persistent,
        "q011an_component_internal_eigenvalue_labels_are_assumed": False,
        "q011ia_ordinal_seventy_seven_interval_inert_diagnostic_is_preserved": True,
    ...
    cycle["claim_boundary"] = (
        ...
        "ordinal 77, its 852-to-852 component-wave quotient and 18718 registered "
        "component-safe phase allocations and target block=7;center=44. It does not "
        "reevaluate ordinals 0 through 76 or classify the later 44722 Q011cb refined "
    ...
    cycle["next_change"] = (
        "Preregister Q011ic to audit the next Q011cb refined overlap in registered order."
        if resolved
        else (
            "Preregister Q011ic to refine only the first unresolved component-safe phase witness."
        )
        if persistent
        else "Repair only the first Q011ib validity failure."
    )
    if not (
        ...
        raise RuntimeError("Q011ib cycle failed strict serialization or digest")
    return cycle


def run_q011ib_study() -> dict[str, Any]:
    started = perf_counter()
    cycle = run_degree_thirty_four_seventy_eighth_component_safe_phase_audit()
    ...
    return {
        ...
        "mathematical_scope": {
            "diagnostic": "seventy-eighth Q011cb witness component-safe complex phase discs",
            "grid": [SIZE, SIZE],
