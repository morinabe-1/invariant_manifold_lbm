"""Q011lp component-safe complex phase discs for Q011cb flatten ordinal one hundred twenty-three."""
...
Q011LO_ARTIFACT_SHA256 = "eeb0f09987228f541e8f86657bebc364933709aa7145acf77c215fd22b8002e1"
Q011LO_RUNNER_SHA256 = "3f26b5626e2dc33ada0ffc277ebec8e6f57683d2238090cb770b6c0e3cb02ab6"
Q011LO_DIGEST_NAMES = (
    "input_digest_sha256",
...
EXPECTED_Q011LO_ALLOCATION_RECORD_DIGEST = (
    "0dd099a44a3bdb67c3f1ce82eec3889e2a3d1245e48ca1b7cfe9fcc0e089c844"
)

RESOLVED_CLASSIFICATION = (
    "the component-safe complex phase discs resolve the one-hundred-twenty-fourth "
    "Q011cb persistent refined witness"
)
PERSISTENT_CLASSIFICATION = (
    "the one-hundred-twenty-fourth Q011cb persistent refined witness persists under "
    "component-safe complex phase discs"
)
INCONCLUSIVE_CLASSIFICATION = "the Q011lp component-safe phase-disc audit is inconclusive"
...
def _q011lp_framed_record_digest() -> Any:
    return q011ih.q011cx._BASE_FRAMED_RECORD_DIGEST("q011lp-component-safe-phase-comparisons-v1")


def _q011lp_exact_fraction_sequence_sha256(
    _domain: bytes,
    values: tuple[Fraction, ...],
) -> str:
    return q011ih.q011cx._BASE_EXACT_FRACTION_SEQUENCE_SHA256(
        b"q011lp-complex-margin-expression-v1",
        values,
    )
...
def _protocol_globals_are_restored() -> bool:
    return bool(
        ...
        and q011lo._protocol_globals_are_restored()
    )


def _sealed_input_audit() -> tuple[dict[str, Any], dict[str, dict[str, Any]]]:
    prior, artifacts = q011lo._sealed_input_audit()
    ...
    digests = tuple(cycle[name] for name in Q011LO_DIGEST_NAMES)
    checks = {
        "q011lo_three_hundred_five_prior_artifacts_and_helpers_reproduce": bool(
            prior["passed"]
            and prior["artifact_count"] == 305
            and prior["direct_digest_count"] == 1_385
            and len(artifacts) == 305
            and all(prior["checks"].values())
        ),
        "q011lo_artifact_and_runner_sha256_match": bool(
            _file_sha256(artifact_path) == Q011LO_ARTIFACT_SHA256
            and _file_sha256(runner_path) == Q011LO_RUNNER_SHA256
            and artifact["runner_source"]["sha256"] == Q011LO_RUNNER_SHA256
        ),
        "q011lo_section_digests_match": digests == Q011LO_DIGESTS,
        "q011lo_valid_interval_inert_outcome_and_boundary_reproduce": bool(
        ...
        "q011lo_parent_partition_and_relations_reproduce": bool(
            fixed["one_hundred_twenty_fourth_parent_witness_selection_audit"][
                "selected_flat_ordinal"
            ]
            == PARENT_FLAT_ORDINAL
            and fixed["compatible_allocation_count"] == EXPECTED_INDIVIDUAL_WAVE_ALLOCATION_COUNT
            and fixed["compatible_allocation_digest_sha256"] == q011lo.EXPECTED_COMPATIBLE_DIGEST
        ...
        "q011lo_artifact_is_finite_strict_json": bool(
            _all_numeric_values_finite(artifact)
            and _strict_json_serializable(artifact)
            and json.dumps(artifact, allow_nan=False)
        ),
        "one_thousand_three_hundred_eighty_nine_direct_digests_are_sealed": (
            prior["direct_digest_count"] + len(digests) == 1_389
        ),
    }
    artifacts["q011lo"] = artifact
    return (
        {
            "prior_q011lo_sealed_input_audit": prior,
            "q011lo": {
                "artifact_filename": artifact_path.name,
                "artifact_sha256": _file_sha256(artifact_path),
                "runner_filename": runner_path.name,
                "runner_sha256": _file_sha256(runner_path),
                "digest_names": list(Q011LO_DIGEST_NAMES),
...
def _fixed_phase_input_audit(
    ...
    fixed, _lookup, wave_compatible, _parent = q011lo._fixed_individual_input_audit(artifacts)
    stored = artifacts["q011lo"]["cycle"]
    ...
    checks = {
        "q011lo_fixed_parent_replays_and_stored_interval_partition_is_inert": bool(
    ...
    audit = {
        ...
        "q011lo_compatible_wave_allocation_count": len(wave_compatible),
        "q011lo_compatible_wave_allocation_digest_sha256": fixed[
...
def _component_wave_counts(individual_counts: tuple[int, ...]) -> tuple[int, ...]:
    if len(individual_counts) != 14:
        raise ValueError("Q011lp requires fourteen Q011lo individual counts")
    return (
        *individual_counts[:4],
...
def _phase_wave_counts(phase_counts: list[int]) -> tuple[int, ...]:
    if len(phase_counts) != 14:
        raise ValueError("Q011lp requires fourteen active canonical counts")
    return (
        *phase_counts[:4],
...
def _allocation_inventory(
    ...
    audit = {
        ...
        "allocation_protocol_adapter": {
            ...
            "ordinal_one_hundred_twenty_three_active_totals": [1, 12, 9, 5, 3, 4],
...
def _phase_product_audit(
    ...
    replacements = {
        ...
        "PARENT_FLAT_ORDINAL": PARENT_FLAT_ORDINAL,
        "_q011ih_framed_record_digest": _q011lp_framed_record_digest,
        "_q011ih_exact_fraction_sequence_sha256": _q011lp_exact_fraction_sequence_sha256,
    }
    try:
        ...
        for name, value in _Q011IH_PROTOCOL_BASELINE.items():
            setattr(q011ih, name, value)
    audit["comparison_stream_domain"] = "q011lp-component-safe-phase-comparisons-v1"
    return audit


def _registered_parameters() -> dict[str, Any]:
    return {
        "protocol": "q011lp-one-hundred-twenty-fourth-component-safe-phase-v1",
        "degree": DEGREE,
        "parent_flat_ordinal": PARENT_FLAT_ORDINAL,
        "output_block": OUTPUT_BLOCK,
        "target_identifier": TARGET_IDENTIFIER,
        ...
        "comparison_stream_domain": "q011lp-component-safe-phase-comparisons-v1",
        "complex_margin_digest_domain": "q011lp-complex-margin-expression-v1",
        "q011lp_allocation_enumerator": {
            "source_runner_sha256": _file_sha256(Path(__file__).resolve()),
...
def run_degree_thirty_four_one_hundred_twenty_fourth_component_safe_phase_audit() -> dict[str, Any]:
    ...
    validity_gates = {
        "q011lo_and_all_prior_proof_objects_are_sealed": {
            "passed": sealed["passed"],
            "threshold": "306 artifacts and 1389 direct digests reproduce",
            "value": sealed["checks"],
        },
        "q011lo_parent_partition_and_interval_inert_result_replay": {
            "passed": phase_input["checks"][
                "q011lo_fixed_parent_replays_and_stored_interval_partition_is_inert"
            ],
            "threshold": "ordinal 123, 5174 individual wave allocations and inert result replay",
            "value": phase_input["q011lo_compatible_wave_allocation_digest_sha256"],
        },
        ...
        "strict_stream_section_digests_runner_and_protocol_provenance_reproduce": {
            "passed": bool(
                ...
                and runner["filename"]
                == "q011lp_degree34_one_hundred_twenty_fourth_component_safe_phase_discs.py"
    ...
    diagnostic_gates = {
        "only_the_registered_one_hundred_twenty_fourth_q011cb_witness_is_refined": {
            "passed": bool(
            ...
            "threshold": "ordinal 123 only, one target and no other overlap",
    ...
    cycle = {
        "question": (
            ...
            "strictly separate every complex product in Q011cb flatten ordinal 123?"
        ),
        **input_sections,
    ...
    prior_theorem = artifacts["q011lo"]["cycle"]["theorem_consequence"]
    cycle["theorem_consequence"] = {
        "component_safe_complex_phase_discs_resolve_one_hundred_twenty_fourth_q011cb_witness": resolved,
        "one_hundred_twenty_fourth_q011cb_witness_persists_under_component_safe_phase_discs": persistent,
        "q011an_component_internal_eigenvalue_labels_are_assumed": False,
        "q011lo_ordinal_one_hundred_twenty_three_interval_inert_diagnostic_is_preserved": True,
    ...
    cycle["claim_boundary"] = (
        ...
        "ordinal 123, its 5174-to-1729 active component-wave quotient and 37940 "
        ...
        "ordinals 0 through 122 or classify the later 44676 "
    ...
    cycle["next_change"] = (
        "Preregister Q011lq to audit Q011cb flatten ordinal 124 in registered order."
        if resolved
        else (
            "Preregister Q011lq to refine only the first unresolved component-safe phase witness."
        )
        if persistent
        else "Repair only the first Q011lp validity failure."
    )
    if not (
        ...
        raise RuntimeError("Q011lp cycle failed strict serialization or digest")
    return cycle


def run_q011lp_study() -> dict[str, Any]:
    started = perf_counter()
    cycle = run_degree_thirty_four_one_hundred_twenty_fourth_component_safe_phase_audit()
    ...
    return {
        ...
        "mathematical_scope": {
            "diagnostic": "one-hundred-twenty-fourth Q011cb witness component-safe complex phase discs",
            "grid": [SIZE, SIZE],
