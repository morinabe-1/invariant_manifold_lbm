"""Q011bi design-only degree-twenty-seven block-support resource audit."""
...
q011bg = q011bh.q011bg
q011ap = q011bg.q011ap
q011as = q011bg.q011as
q011b = q011bg.q011b
q011u = q011bg.q011u
q011z = q011bg.q011z
...
EXPECTED_DEGREE_AGGREGATE_COUNT = 4_060
EXPECTED_EXPANDED_CONTROL_COUNT = 201_376
EXPECTED_OLD_SEPARATED_AGGREGATE_COUNT = 3_101
EXPECTED_OVERLAP_AGGREGATE_COUNT = 959
EXPECTED_SELECTED_GROUP_SIZES = (8, 4, 4, 8)
EXPECTED_UNIQUE_EXTERNAL_GROUP_COUNT = 38
EXPECTED_TARGET_IDENTIFIER_COUNT = 488
...
EXPECTED_FIRST_COUNTS = (0, 4, 3, 20)
EXPECTED_LAST_COUNTS = (26, 0, 1, 0)
EXPECTED_COUNT_TUPLE_DIGEST = "7fb69ae484ac6c0fe5cefad46a3d7a42175ed51250dd763216b46841a86dd695"
EXPECTED_EXTERNAL_GROUP_DIGEST = "79f4abce73265951b8cbae1c5cd93d249480629aa3185722e20d560446e5bf26"
EXPECTED_OVERLAP_RECORD_DIGEST = "db57390c234b941eddcb29cfade6cef3b94ba8682835aa4f8a5481744c337c48"
EXPECTED_TARGET_RECORD_DIGEST = "df98a7c8ffeca51792708b467141322d54fe8c10051078e47ccfea142ab976cc"
EXPECTED_INVENTORY_DIGEST = "33b99cc5426e4dbcb7acf767daec77e0792b96776d7f6ef4d3e974cf317ab4ef"

EXPECTED_PRIOR_IDENTIFIER_COUNT = 568
EXPECTED_ACTIVE_REUSED_IDENTIFIER_COUNT = 476
EXPECTED_INACTIVE_RETAINED_IDENTIFIER_COUNT = 92
EXPECTED_ADDED_TARGET_IDENTIFIER_COUNT = 36
EXPECTED_ACTIVE_IDENTIFIER_COUNT = 512
EXPECTED_FINAL_IDENTIFIER_COUNT = 604
EXPECTED_PRIOR_RECORD_DIGEST = "7077f7c72acd166c15b12962f4c273b3837898e74689b582329cfd31ece98753"
...
EXPECTED_ADDED_RECORD_DIGEST = "38f1b3c821f73c4db97d497a033b7a84725d2c845443bde9e01326d17d7b8fe0"
EXPECTED_ACTIVE_RECORD_DIGEST = "1a6fd9676b3ccdca51587ef4587937f8f0af8a778bdb4ce364a89ef0fde2db08"
EXPECTED_FINAL_RECORD_DIGEST = "7fe2788ea086583cc7b6c4f19ceb24df3b8135ad35f92883a182c2b04fcd3b5f"
EXPECTED_OLD_CLASS_COUNTS = (4, 2, 3, 6)
EXPECTED_MERGED_CLASS_COUNTS = (1, 1, 2, 2)
EXPECTED_HULL_RECORD_DIGEST = q011bg.EXPECTED_HULL_RECORD_DIGEST
EXPECTED_MERGED_MEMBERSHIP_DIGEST = q011bg.EXPECTED_MERGED_MEMBERSHIP_DIGEST

EXPECTED_CLASS_POWER_COUNT = 154
EXPECTED_CLASS_POWER_KEY_DIGEST = (
    "975dd65873ad2fbfcabc1b038ee3ecc5be7cace52eb7475cb4ef7d257f87af36"
)
EXPECTED_GROUP_POOL_KEY_COUNT = 104
EXPECTED_GROUP_POOL_KEY_DIGEST = (
    "2f29c923bf95adfca2e64ad1332a472256155496b86269115b4fcc97e8e2a999"
)
EXPECTED_GROUP_SIGNATURE_COUNT = 705
EXPECTED_PAIR_POOL_KEY_COUNT = 341
EXPECTED_PAIR_POOL_KEY_DIGEST = (
    "7d5b89286d86c0c38379af39b6e5257c7625ce811b7cd74a910f0914407563c1"
)
EXPECTED_PAIR_SIGNATURE_ENTRY_COUNT = 10_293
EXPECTED_CONVOLUTION_CALL_COUNT = 11_649
EXPECTED_MODULUS_SIGNATURE_COUNT = 43_285
EXPECTED_MAXIMUM_LIVE_SIGNATURE_COUNT = 180
EXPECTED_TWO_PRODUCT_ARRAY_BYTES = 2_880
EXPECTED_ORIGINAL_MONOMIAL_COUNT = 25_561_324_661_692
EXPECTED_MAXIMUM_AGGREGATE_MONOMIAL_COUNT = 272_544_272_000
EXPECTED_SAFE_INT64_CRUDE_BOUND = 4_633_252_624_000
EXPECTED_DISTINCT_COMPARISON_UPPER_BOUND = 763_404
EXPECTED_WEIGHTED_COMPARISON_UPPER_BOUND = 502_998_748_050_560
EXPECTED_RESOURCE_RECORD_DIGEST = (
    "ec1fc3d6ccb2803c978cee6ac1dc8e835d6ec6957255465e9930a1cdc4d2781a"
)
EXPECTED_PROJECTED_SECONDS = Fraction(408_544_620_597, 1_154_895_680_000)
EXPECTED_DOUBLE_SAFETY_SECONDS = Fraction(408_544_620_597, 577_447_840_000)
EXPECTED_TRACEMALLOC_SAFETY_BYTES = 133_324
EXPECTED_PROCESS_MEMORY_SAFETY_BYTES = 367_939

RESOURCE_LIMITS = dict(q011bg.RESOURCE_LIMITS)
GO_DECISION = "go_for_degree_twenty_seven_coalesced_preregistration"
STOP_DECISION = "stop_before_degree_twenty_seven_coalesced_full_sweep"
INCONCLUSIVE_DECISION = "inconclusive_resource_audit"
SCIENTIFIC_OUTCOME = "not_evaluated"
ACTUAL_RESONANCE_OUTCOME = "not_evaluated"

Q011BH_ARTIFACT_SHA256 = "34294fc77fd5ade05ab61812088fdee6d8cec63a5e22c0eac555c3647b073349"
Q011BH_RUNNER_SHA256 = "b934c50138890dd329d2d0dc75c78f98df9540d3e9b5eb3a463347f2c1a9b192"
Q011BH_DIGEST_NAMES = (
    "input_digest_sha256",
...
def _sealed_input_audit() -> tuple[dict[str, Any], dict[str, dict[str, Any]]]:
    prior, artifacts = q011bh._sealed_input_audit()
    artifact_path = _artifact_directory() / "q011bh_degree26_coalesced_sweep.json"
    runner_path = Path(q011bh.__file__).resolve()
    artifact = json.loads(artifact_path.read_text(encoding="utf-8"))
    cycle = artifact["cycle"]
    digests = tuple(cycle[name] for name in Q011BH_DIGEST_NAMES)
    theorem = cycle["theorem_consequence"]
    checks = {
        "q011bh_thirty_eight_prior_artifacts_and_helpers_reproduce": bool(
            prior["passed"]
            and prior["direct_digest_count"] == 185
            and len(artifacts) == 38
            and all(prior["checks"].values())
        ),
        "q011bh_artifact_sha256_matches": _file_sha256(artifact_path)
        == Q011BH_ARTIFACT_SHA256,
        "q011bh_runner_sha256_matches": bool(
            _file_sha256(runner_path) == Q011BH_RUNNER_SHA256
            and artifact["runner_source"]["sha256"] == Q011BH_RUNNER_SHA256
        ),
        "q011bh_section_digests_match": digests == Q011BH_DIGESTS,
        "q011bh_accepted_degree_twenty_six_outcome_reproduces": bool(
            ...
            and theorem["degree_twenty_six_external_nonresonance_is_certified"]
            and theorem["certified_external_nonresonance_degrees"] == list(range(2, 27))
            and theorem["missing_external_nonresonance_degrees"] == list(range(27, 91))
        ),
        "q011bh_claim_boundary_is_present": bool(cycle["claim_boundary"]),
        "q011bh_package_source_metadata_matches": artifact["source"] == source_metadata(),
        "q011bh_artifact_is_strict_finite_json": bool(
            _all_numeric_values_finite(artifact)
            and _strict_json_serializable(artifact)
            and json.dumps(artifact, allow_nan=False)
        ),
        "one_hundred_eighty_nine_direct_digests_are_sealed": (
            prior["direct_digest_count"] + len(digests) == 189
        ),
    }
    artifacts["q011bh"] = artifact
    return (
        {
            "prior_q011bh_sealed_input_audit": prior,
            "q011bh": {
                "artifact_filename": artifact_path.name,
                "artifact_sha256": _file_sha256(artifact_path),
                "runner_filename": runner_path.name,
                "runner_sha256": _file_sha256(runner_path),
                "digest_names": list(Q011BH_DIGEST_NAMES),
...
def _degree_twenty_seven_inventory_audit(
    ...
    checks = {
        ...
        "q011u_degree_twenty_seven_record_is_unique_and_complete": bool(
...
def _degree_twenty_seven_envelope_audit(
    artifacts: dict[str, dict[str, Any]],
    ...
    prior_records = artifacts["q011bg"]["cycle"]["degree_twenty_six_envelope_audit"][
        "final_disc_records"
    ]
    ...
    checks = {
        ...
        "all_q011bg_records_are_retained_bitwise": bool(
        ...
        "registered_degree_twenty_seven_extension_reproduces": bool(
    ...
    audit = {
        ...
        "prior_q011bg_identifier_count": len(prior_by_identifier),
        "active_reused_q011bg_identifier_count": len(common_identifiers),
        "inactive_retained_q011bg_identifier_count": len(inactive_identifiers),
        "added_target_identifier_count": len(added_identifiers),
        "removed_q011bg_identifier_count": 0,
...
def _degree_twenty_seven_resource_audit(
    ...
    record["full_degree_twenty_seven_monomial_list_retained"] = False
    ...
    checks = {
        ...
        "streaming_design_does_not_evaluate_degree_twenty_seven_relations": bool(
            not record["full_degree_twenty_seven_monomial_list_retained"]
...
def _registered_parameters() -> dict[str, Any]:
    return {
        ...
        "degree_twenty_seven_relations_evaluated": False,
        "resource_limits": RESOURCE_LIMITS,
        "resource_limits_are_inherited_unchanged_from_q011ap": True,
        "go_decision": GO_DECISION,
        "stop_decision": STOP_DECISION,
        "degree_twenty_seven_external_nonresonance_claimed": False,
...
def run_degree_twenty_seven_resource_audit() -> dict[str, Any]:
    ...
    (
        ...
        _external_indices,
        target_groups,
    ) = _degree_twenty_seven_inventory_audit(artifacts)
    envelope, merged_classes, _ = _degree_twenty_seven_envelope_audit(
        artifacts, selected_groups, external_merged, target_groups
    )
    resource = _degree_twenty_seven_resource_audit(
        merged_classes, selected_groups, overlap_counts, target_groups
    )
    registered = _registered_parameters()
    runner = _runner_source_metadata()
    input_sections = {"registered_parameters": registered, "sealed_input_audit": sealed}
    inventory_sections = {"degree_twenty_seven_inventory_audit": inventory}
    envelope_sections = {"degree_twenty_seven_envelope_audit": envelope}
    resource_sections = {"degree_twenty_seven_coalesced_resource_audit": resource}
    ...
    validity_gates = {
        "q011bh_and_all_prior_proof_objects_are_sealed": {
            "passed": sealed["passed"],
            "threshold": "39 artifacts and 189 direct digests reproduce",
            "value": sealed["checks"],
        },
        "degree_twenty_seven_inventory_reproduces": {
            "passed": inventory["passed"],
            "threshold": "4060 aggregates split as 3101 old plus 959 overlap",
            "value": inventory["checks"],
        },
        "degree_twenty_seven_monotone_envelope_and_source_hulls_reproduce": {
            "passed": envelope["passed"],
            "threshold": "568 prior records retained, 36 added and six source hulls",
            "value": envelope["checks"],
        },
        "degree_twenty_seven_design_only_resource_contract_reproduces": {
            "passed": resource["passed"],
            "threshold": "registered exact combinatorial resources with zero relations",
            "value": resource["checks"],
        },
        "no_degree_twenty_seven_relation_object_is_constructed": {
            "passed": bool(
        ...
        "section_digests_runner_and_json_are_strict": {
            "passed": bool(
                ...
                == len(resource_digest)
                == 64
                and runner["filename"] == "q011bi_degree27_resource_estimate.py"
    ...
    cycle = {
        "question": (
            "Can the degree-twenty-seven block-support-coalesced full sweep be "
    ...
    cycle["theorem_consequence"] = {
        "degree_twenty_seven_coalesced_full_sweep_preregistration_is_resource_supported": decision
        == GO_DECISION,
        "degree_twenty_seven_external_nonresonance_is_certified": False,
        "an_actual_degree_twenty_seven_external_resonance_is_ruled_out": False,
        "certified_external_nonresonance_degrees": list(range(2, 27)),
        "degree_91_and_higher_modulus_tail_is_preserved": True,
        "missing_external_nonresonance_degrees": list(range(27, 91)),
        "all_spectral_quotient_nonresonances_are_certified": False,
        "ssm_existence_or_uniqueness_is_certified": False,
        "normal_attraction_or_a_basin_is_certified": False,
        "q011bh_degree_twenty_six_certificate_is_preserved": True,
    }
    cycle["claim_boundary"] = (
        "This design-only audit concerns the degree-twenty-seven modulus-overlap "
        "inventory, six Q011as source hulls, all 488 current target discs, the "
        "604-record monotone proof inventory, exact combinatorial resource counts and "
        "calibrated projections for the fixed 17x17 repaired exact map on one fixed "
        "conservation leaf. It evaluates no degree-twenty-seven product-target relation "
        "and certifies no degree-twenty-seven nonresonance, actual resonance, minimum "
    ...
    cycle["next_change"] = (
        "Preregister the Q011bj degree-twenty-seven full sweep with fixed inputs, "
        "arithmetic and acceptance rules."
        if decision == GO_DECISION
        else "Redesign only the first failed degree-twenty-seven resource dimension "
        "before any degree-twenty-seven relation evaluation."
        if decision == STOP_DECISION
        else "Repair only the first Q011bi validity failure before changing the design."
    )
    if not (
        ...
        raise RuntimeError("Q011bi cycle failed strict serialization or digest")
    return cycle


def run_q011bi_study() -> dict[str, Any]:
    cycle = run_degree_twenty_seven_resource_audit()
    resource = cycle["degree_twenty_seven_coalesced_resource_audit"]
    return {
        "schema_version": 1,
        ...
        "arithmetic_runtime": {
            ...
            "degree_twenty_seven_product_enclosure": "not constructed",
            "degree_twenty_seven_fourier_coefficient_matrices": "not constructed",
            "degree_twenty_seven_relation_classification": "not evaluated",
        ...
        "mathematical_scope": {
            "diagnostic": "design-only degree-27 block-support resource feasibility",
            "grid": [SIZE, SIZE],
            "fixed_conservation_leaf": True,
            "degree": DEGREE,
            "degree_twenty_seven_external_nonresonance_claim": False,
            "actual_degree_twenty_seven_external_resonance_ruled_out_claim": False,
