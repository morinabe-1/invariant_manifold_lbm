"""Q011nm individual-disc partition audit for Q011cb flatten ordinal 148."""
...
EXPECTED_CLASS_TOTALS = (1, 12, 8, 1, 5, 4, 3)
EXPECTED_SOURCE_COUNTS = (1, 0, 12, 0, 8, 0, 1, 0, 0, 5, 0, 4, 0, 3)
...
EXPECTED_OCCUPIED_RECORD_DIGEST = "ebd78a2dec5c9657119b8790ddad330140dd1ee98ba752e2fa826135155c0e2e"
EXPECTED_IDENTIFIER_ORDER_DIGEST = (
    "c90ea70931e0bb67733cb9179566e166baf2a67756933394db785fb4f941276a"
)
EXPECTED_ALLOCATION_DIGEST = "6d6feb59119b97d3a74c4d962ce2b93e5fa96d64e769e2e028f7ddebef7d91af"
EXPECTED_COMPATIBLE_DIGEST = "b6f56d5a1f615a0d39c2fd5c62a03e18a4bc3f16553d71ee1d7e05a73965ea6e"

EXPECTED_PARENT_WAVE_MULTIPLICITY = 3_104
EXPECTED_PARENT_BLOCK_ZERO_MULTIPLICITY = 0
EXPECTED_PARENT_INTERSECTION_WIDTH_HEX = "0x1.4b330e4fc5e0ep-31"
EXPECTED_PARENT_CENTER_RELATION = "target_below_product"
EXPECTED_PARENT_CENTER_GAP_HEX = "0x1.32d74ca222c37p-28"
EXPECTED_PARENT_WITNESS_DIGEST = "ab30e6a4608b0b414729a39ae762c551374cd40a2986344b92db1eddc8eb9f75"
EXPECTED_PARENT_PRODUCT_DIGEST = "b4cdf154a6c292cc29ab9ba84631f5afe92338820234a7a0270faf9068687b56"
...
Q011NL_ARTIFACT_SHA256 = "7b242837cec2e4537ec980afcc627004545ee7a7a3021938e8704bbf0d266cdf"
Q011NL_RUNNER_SHA256 = "8ba59adfb1b4fbe77ff7cbc240faf3f34aef6bf6f243002d79819043261e9805"
Q011NL_DIGEST_NAMES = (
    "input_digest_sha256",
...
Q011NL_DIGESTS = (
    "942397591ba4b1ad858fa0ad0651a1d7f92fcbfa45ee4294b3e4e59bc37a8630",
    ...
    "54656986f8b38b32b4874e68bdbdc826ffab4bc0847870df31a480c28b4d5424",
)
EXPECTED_Q011NL_STREAM_DIGEST = "91711b7294cf5849e68485e15cb85551cd3d72a4152971c2c55afeffd0c42c6f"
EXPECTED_ORDINAL_ONE_HUNDRED_FORTY_SEVEN_RESOLUTION_DIGEST = (
    "5230fd7936461e9a4b0c7c22bece80b21c02827e9ec05805b4ac2135b88fa34e"
)
ALLOCATION_STREAM_DOMAIN = "q011nm-individual-partition-allocation-records-v1"

INERT_CLASSIFICATION = (
    "the individual-disc partition is interval-inert for the one-hundred-forty-ninth "
    "Q011cb witness"
)
RESOLVED_CLASSIFICATION = (
    "the one-hundred-forty-ninth Q011cb witness is resolved by individual partition"
)
EFFECTIVE_PERSISTENT_CLASSIFICATION = (
    "the individual-disc partition changes intervals but the one-hundred-forty-ninth "
    "Q011cb witness persists"
)
INCONCLUSIVE_CLASSIFICATION = "the Q011nm individual-disc partition audit is inconclusive"
...
def _protocol_globals_are_restored() -> bool:
    return bool(
        ...
        and q011nl._protocol_globals_are_restored()
    )
...
def _sealed_input_audit_cached() -> tuple[
    ...
    prior, artifacts = q011nl._sealed_input_audit()
    ...
    digests = tuple(cycle[name] for name in Q011NL_DIGEST_NAMES)
    checks = {
        "q011nl_three_hundred_fifty_four_prior_artifacts_and_helpers_reproduce": bool(
            prior["passed"]
            and prior["artifact_count"] == 354
            and prior["direct_digest_count"] == 1_605
            and len(artifacts) == 354
            and all(prior["checks"].values())
        ),
        "q011nl_artifact_and_runner_sha256_match": bool(
            _file_sha256(artifact_path) == Q011NL_ARTIFACT_SHA256
            and _file_sha256(runner_path) == Q011NL_RUNNER_SHA256
            and artifact["runner_source"]["sha256"] == Q011NL_RUNNER_SHA256
        ),
        "q011nl_section_digests_match": digests == Q011NL_DIGESTS,
        "q011nl_valid_phase_resolution_and_boundary_reproduce": bool(
        ...
        "q011nl_registered_ordinal_one_hundred_forty_seven_resolution_reproduces": bool(
        ...
        "q011nl_artifact_is_finite_strict_json": bool(
            _all_numeric_values_finite(artifact)
            and _strict_json_serializable(artifact)
            and json.dumps(artifact, allow_nan=False)
        ),
        "one_thousand_six_hundred_ten_direct_digests_are_sealed": (
            prior["direct_digest_count"] + len(digests) == 1_610
        ),
    }
    artifacts["q011nl"] = artifact
    return (
        {
            "prior_q011nl_sealed_input_audit": prior,
            "q011nl": {
                "artifact_filename": artifact_path.name,
                "artifact_sha256": _file_sha256(artifact_path),
                "runner_filename": runner_path.name,
                "runner_sha256": _file_sha256(runner_path),
                "digest_names": list(Q011NL_DIGEST_NAMES),
...
def _fixed_individual_input_audit(
    ...
    q011nl_cycle = artifacts["q011nl"]["cycle"]
    q011nl_comparison = q011nl_cycle["complex_phase_product_disc_audit"]
    selection["checks"][
        "ordinals_zero_through_one_hundred_forty_seven_are_sealed_phase_resolutions"
    ] = bool(
        previous_check
        and q011nl_cycle["theorem_consequence"][
            "component_safe_complex_phase_discs_resolve_one_hundred_forty_eighth_q011cb_witness"
        ]
        and q011nl_comparison["global_minimum_margin_witness"][
            "witness_digest_sha256"
        ]
        == EXPECTED_ORDINAL_ONE_HUNDRED_FORTY_SEVEN_RESOLUTION_DIGEST
    )
    selection["checks"][
        "registered_ordinal_one_hundred_forty_eight_parent_witness_reproduces"
    ] = registered_check
    ...
    selection["previous_phase_resolved_ordinals"] = list(range(148))
    selection["ordinal_one_hundred_forty_seven_resolution_digest_sha256"] = (
        EXPECTED_ORDINAL_ONE_HUNDRED_FORTY_SEVEN_RESOLUTION_DIGEST
    )
    selection["one_hundred_forty_ninth_parent_witness"] = selection.pop(
        "third_parent_witness"
    )
    selection["one_hundred_forty_ninth_parent_witness_digest_sha256"] = (
        selection.pop("third_parent_witness_digest_sha256")
    )
    selection["passed"] = all(selection["checks"].values())
    fixed["one_hundred_forty_ninth_parent_witness_selection_audit"] = selection
    fixed["checks"].pop("registered_third_parent_selection_reproduces")
    fixed["checks"][
        "registered_one_hundred_forty_ninth_parent_selection_reproduces"
    ] = selection["passed"]
...
def _interval_record(lower: Fraction, upper: Fraction) -> dict[str, Any]:
    if not lower <= upper:
        raise RuntimeError("Q011nm constructed an unordered interval")
    return {
...
def run_degree_thirty_four_one_hundred_forty_ninth_individual_partition_audit() -> dict[str, Any]:
    ...
    validity_gates = {
        "q011nl_and_all_prior_proof_objects_are_sealed": {
            "passed": sealed["passed"],
            "threshold": "355 artifacts and 1610 direct digests reproduce",
            "value": sealed["checks"],
        },
        "registered_one_hundred_forty_ninth_parent_witness_reproduces": {
            "passed": selection["passed"],
            "threshold": "ordinal 148, class counts, 3104 multiplicity and exact witness",
            "value": selection[
                "one_hundred_forty_ninth_parent_witness_digest_sha256"
            ],
        },
        ...
        "strict_section_digests_runner_and_protocol_provenance_reproduce": {
            "passed": bool(
                ...
                == 64
                and runner["filename"]
                == "q011nm_degree34_one_hundred_forty_ninth_individual_partition_audit.py"
    ...
    diagnostic_gates = {
        "only_the_registered_one_hundred_forty_ninth_q011cb_signature_is_refined": {
            "passed": bool(
            ...
            "threshold": "ordinal 148 only, one target and no other aggregate",
    ...
    cycle = {
        "question": (
            "Does splitting Q011cb flatten ordinal 148 into fourteen singleton "
    ...
    prior_theorem = artifacts["q011nl"]["cycle"]["theorem_consequence"]
    cycle["theorem_consequence"] = {
        "individual_partition_is_interval_inert_for_one_hundred_forty_ninth_q011cb_witness": inert,
        "one_hundred_forty_ninth_q011cb_witness_is_resolved_by_individual_partition": resolved,
        "individual_partition_changes_intervals_but_one_hundred_forty_ninth_q011cb_witness_persists": (
            effective_persistent
        ),
        "q011nl_ordinal_one_hundred_forty_seven_phase_resolution_is_preserved": True,
        **{
            name: value
    ...
    cycle["claim_boundary"] = (
        "This diagnostic concerns only Q011cb flatten ordinal 148, its 3104 "
        ...
        "It uses ordinals 0 through 147 only as sealed selection boundaries and does "
        "not reevaluate them. It does not evaluate complex phase, the later 44651 "
    ...
    cycle["next_change"] = (
        "Preregister Q011nn to expand only the registered 3104 wave allocations into component-safe complex phase discs."
        if inert
        else "Preregister Q011nn to audit flatten ordinal 149 in registered order."
        if resolved
        else (
            "Preregister Q011nn to refine only the first remaining individual-allocation overlap by component-safe complex phase."
        )
        if effective_persistent
        else "Repair only the first Q011nm validity failure."
    )
    if not (
        ...
        raise RuntimeError("Q011nm cycle failed strict serialization or digest")
    return cycle


def run_q011nm_study() -> dict[str, Any]:
    cycle = run_degree_thirty_four_one_hundred_forty_ninth_individual_partition_audit()
    ...
    return {
        ...
        "mathematical_scope": {
            "diagnostic": (
                "one-hundred-forty-ninth Q011cb witness individual-disc partition"
            ),
            "grid": [SIZE, SIZE],
