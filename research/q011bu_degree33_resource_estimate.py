"""Q011bu design-only degree-thirty-three block-support resource audit."""
...
q011bs = q011bt.q011bs
q011bq = q011bs.q011bq
q011bo = q011bq.q011bo
...
EXPECTED_DEGREE_AGGREGATE_COUNT = 7_140
EXPECTED_EXPANDED_CONTROL_COUNT = 501_942
EXPECTED_OLD_SEPARATED_AGGREGATE_COUNT = 4_454
EXPECTED_OVERLAP_AGGREGATE_COUNT = 2_686
EXPECTED_SELECTED_GROUP_SIZES = (8, 4, 4, 8)
EXPECTED_UNIQUE_EXTERNAL_GROUP_COUNT = 74
EXPECTED_TARGET_IDENTIFIER_COUNT = 1_128
EXPECTED_MULTI_TARGET_AGGREGATE_COUNT = 25
...
EXPECTED_FIRST_COUNTS = (0, 2, 11, 20)
EXPECTED_LAST_COUNTS = (32, 0, 1, 0)
EXPECTED_COUNT_TUPLE_DIGEST = "e80646eb66ec39cc034e010624ffe56101b4d8fb8272e155234cd3e706363b3f"
EXPECTED_EXTERNAL_GROUP_DIGEST = "972d47d28d801f71b7946d08aa75235cd324e9497c8484a7ec05431fa9a6c38e"
EXPECTED_OVERLAP_RECORD_DIGEST = "0ccef33cefbd82b1e24196a8d6202f72f86aa7027a3ccab140a4e516075ac345"
EXPECTED_TARGET_RECORD_DIGEST = "36f9c8b90808abb20c9864aad6a69941e036270debe94d078094735b0c1f7856"
EXPECTED_INVENTORY_DIGEST = "6d40bc6c162c0d79d765372dcd82c0e740833148563eb1ef1d40868f2360be82"

EXPECTED_PRIOR_IDENTIFIER_COUNT = 1_188
EXPECTED_ACTIVE_REUSED_IDENTIFIER_COUNT = 1_048
EXPECTED_INACTIVE_RETAINED_IDENTIFIER_COUNT = 140
EXPECTED_ADDED_TARGET_IDENTIFIER_COUNT = 104
EXPECTED_ACTIVE_IDENTIFIER_COUNT = 1_152
EXPECTED_FINAL_IDENTIFIER_COUNT = 1_292
EXPECTED_PRIOR_RECORD_DIGEST = "818f1af5c2f40ae728e5fc89d57e19c2d71028e1868e50612582c50d834af345"
...
EXPECTED_INACTIVE_IDENTIFIER_DIGEST = (
    "f423ba54a62919598cf3a2c585c31ffd1a61b8e6add7c9cfa398ccb07f3d9482"
)
EXPECTED_ADDED_IDENTIFIER_DIGEST = (
    "bb1fdf55b4f4360e62fcb19b8b1ae480946d03bc70c2371a9a089eda16732986"
)
EXPECTED_ADDED_RECORD_DIGEST = "a07aad29e243b803e0b02387a69e0756eedaf48fdf08f2b032803753350e73b9"
EXPECTED_ACTIVE_RECORD_DIGEST = "c68db1feabae7d4f018ec04664c3a764152280dc90fc30523883c9d543f74b5e"
EXPECTED_FINAL_RECORD_DIGEST = "0effd6f8fbe95972733deacd266785479983e572107a9967bbfd52f57646dbab"
...
EXPECTED_CLASS_POWER_COUNT = 193
EXPECTED_CLASS_POWER_KEY_DIGEST = (
    "4ebd9217d4c92cc96a773bcbea1fd8df0bbfdf23f9bd0307729ddfb1935918c2"
)
EXPECTED_GROUP_POOL_KEY_COUNT = 129
EXPECTED_GROUP_POOL_KEY_DIGEST = (
    "e83c20402037557a1ba8ee4c3efcc4c0d71df45a9c3d13d15fa910d5b9783d02"
)
EXPECTED_GROUP_SIGNATURE_COUNT = 1_121
EXPECTED_PAIR_POOL_KEY_COUNT = 771
EXPECTED_PAIR_POOL_KEY_DIGEST = (
    "1ec0bbde93771b1c512734369e81d0f6704da178e575f4bb3a88a6bb904f73e8"
)
EXPECTED_PAIR_SIGNATURE_ENTRY_COUNT = 39_643
EXPECTED_CONVOLUTION_CALL_COUNT = 41_820
EXPECTED_MODULUS_SIGNATURE_COUNT = 181_711
EXPECTED_MAXIMUM_LIVE_SIGNATURE_COUNT = 272
EXPECTED_TWO_PRODUCT_ARRAY_BYTES = 4_352
EXPECTED_ORIGINAL_MONOMIAL_COUNT = 1_182_191_544_739_044
EXPECTED_MAXIMUM_AGGREGATE_MONOMIAL_COUNT = 4_835_313_100_800
EXPECTED_SAFE_INT64_CRUDE_BOUND = 82_200_322_713_600
EXPECTED_DISTINCT_COMPARISON_UPPER_BOUND = 2_754_464
EXPECTED_WEIGHTED_COMPARISON_UPPER_BOUND = 16_429_979_607_740_272
EXPECTED_RESOURCE_RECORD_DIGEST = (
    "03849dc4d825d7d19ab2d87e0bf8dfb37a36d5b583259a21ac0ccab49656e85e"
)
EXPECTED_PROJECTED_SECONDS = Fraction(184_260_471_819, 144_361_960_000)
EXPECTED_DOUBLE_SAFETY_SECONDS = Fraction(184_260_471_819, 72_180_980_000)
...
GO_DECISION = "go_for_degree_thirty_three_coalesced_preregistration"
STOP_DECISION = "stop_before_degree_thirty_three_coalesced_full_sweep"
INCONCLUSIVE_DECISION = "inconclusive_resource_audit"
SCIENTIFIC_OUTCOME = "not_evaluated"
ACTUAL_RESONANCE_OUTCOME = "not_evaluated"

Q011BT_ARTIFACT_SHA256 = "d48b4f965586299462df4fb3cc0361c7bd6b47b18533f6980f234c26b3ff65fb"
Q011BT_RUNNER_SHA256 = "a19c79c4e36b6114567c2c7c3db26c20372b5114dd5e932e1f48252433b8f7a5"
Q011BT_DIGEST_NAMES = (
    "input_digest_sha256",
...
def _sealed_input_audit() -> tuple[dict[str, Any], dict[str, dict[str, Any]]]:
    prior, artifacts = q011bt._sealed_input_audit()
    artifact_path = _artifact_directory() / "q011bt_degree32_coalesced_sweep.json"
    runner_path = Path(q011bt.__file__).resolve()
    artifact = json.loads(artifact_path.read_text(encoding="utf-8"))
    cycle = artifact["cycle"]
    digests = tuple(cycle[name] for name in Q011BT_DIGEST_NAMES)
    theorem = cycle["theorem_consequence"]
    checks = {
        "q011bt_fifty_prior_artifacts_and_helpers_reproduce": bool(
            prior["passed"]
            and prior["direct_digest_count"] == 239
            and len(artifacts) == 50
            and all(prior["checks"].values())
        ),
        "q011bt_artifact_sha256_matches": _file_sha256(artifact_path)
        == Q011BT_ARTIFACT_SHA256,
        "q011bt_runner_sha256_matches": bool(
            _file_sha256(runner_path) == Q011BT_RUNNER_SHA256
            and artifact["runner_source"]["sha256"] == Q011BT_RUNNER_SHA256
        ),
        "q011bt_section_digests_match": digests == Q011BT_DIGESTS,
        "q011bt_accepted_degree_thirty_two_outcome_reproduces": bool(
            artifact["study_gate"] == "passed"
            and artifact["scientific_outcome"] == "accepted"
            and artifact["actual_resonance_outcome"]
            == q011bt.ACCEPTED_ACTUAL_RESONANCE_OUTCOME
            and cycle["failed_validity_order"] == []
            and cycle["failed_hypothesis_order"] == []
            and theorem["degree_thirty_two_external_nonresonance_is_certified"]
            and theorem["certified_external_nonresonance_degrees"] == list(range(2, 33))
            and theorem["missing_external_nonresonance_degrees"] == list(range(33, 91))
        ),
        "q011bt_claim_boundary_is_present": bool(cycle["claim_boundary"]),
        "q011bt_package_source_metadata_matches": artifact["source"] == source_metadata(),
        "q011bt_artifact_is_strict_finite_json": bool(
            _all_numeric_values_finite(artifact)
            and _strict_json_serializable(artifact)
            and json.dumps(artifact, allow_nan=False)
        ),
        "two_hundred_forty_three_direct_digests_are_sealed": (
            prior["direct_digest_count"] + len(digests) == 243
        ),
    }
    artifacts["q011bt"] = artifact
    return (
        {
            "prior_q011bt_sealed_input_audit": prior,
            "q011bt": {
                "artifact_filename": artifact_path.name,
                "artifact_sha256": _file_sha256(artifact_path),
                "runner_filename": runner_path.name,
                "runner_sha256": _file_sha256(runner_path),
                "digest_names": list(Q011BT_DIGEST_NAMES),
...
def _degree_thirty_three_inventory_audit(
    ...
    checks = {
        ...
        "q011u_degree_thirty_three_record_is_unique_and_complete": bool(
...
def _degree_thirty_three_envelope_audit(
    artifacts: dict[str, dict[str, Any]],
    ...
    prior_records = artifacts["q011bs"]["cycle"]["degree_thirty_two_envelope_audit"][
        "final_disc_records"
    ]
    ...
    checks = {
        ...
        "all_q011bs_records_are_retained_bitwise": bool(
        ...
        "registered_degree_thirty_three_extension_reproduces": bool(
    ...
    audit = {
        ...
        "prior_q011bs_identifier_count": len(prior_by_identifier),
        "active_reused_q011bs_identifier_count": len(common_identifiers),
        "inactive_retained_q011bs_identifier_count": len(inactive_identifiers),
        "added_target_identifier_count": len(added_identifiers),
        "removed_q011bs_identifier_count": 0,
...
def _degree_thirty_three_resource_audit(
    ...
    record["full_degree_thirty_three_monomial_list_retained"] = False
    ...
    checks = {
        ...
        "streaming_design_does_not_evaluate_degree_thirty_three_relations": bool(
            not record["full_degree_thirty_three_monomial_list_retained"]
...
def _registered_parameters() -> dict[str, Any]:
    return {
        ...
        "degree_thirty_three_relations_evaluated": False,
        "resource_limits": RESOURCE_LIMITS,
        "resource_limits_are_inherited_unchanged_from_q011ap": True,
        "go_decision": GO_DECISION,
        "stop_decision": STOP_DECISION,
        "degree_thirty_three_external_nonresonance_claimed": False,
...
def run_degree_thirty_three_resource_audit() -> dict[str, Any]:
    ...
    (
        ...
        _external_indices,
        target_groups,
    ) = _degree_thirty_three_inventory_audit(artifacts)
    envelope, merged_classes, _ = _degree_thirty_three_envelope_audit(
        artifacts, selected_groups, external_merged, target_groups
    )
    resource = _degree_thirty_three_resource_audit(
        merged_classes, selected_groups, overlap_counts, target_groups
    )
    registered = _registered_parameters()
    runner = _runner_source_metadata()
    input_sections = {"registered_parameters": registered, "sealed_input_audit": sealed}
    inventory_sections = {"degree_thirty_three_inventory_audit": inventory}
    envelope_sections = {"degree_thirty_three_envelope_audit": envelope}
    resource_sections = {"degree_thirty_three_coalesced_resource_audit": resource}
    ...
    validity_gates = {
        "q011bt_and_all_prior_proof_objects_are_sealed": {
            "passed": sealed["passed"],
            "threshold": "51 artifacts and 243 direct digests reproduce",
            "value": sealed["checks"],
        },
        "degree_thirty_three_inventory_reproduces": {
            "passed": inventory["passed"],
            "threshold": "7140 aggregates split as 4454 old plus 2686 overlap",
            "value": inventory["checks"],
        },
        "degree_thirty_three_monotone_envelope_and_source_hulls_reproduce": {
            "passed": envelope["passed"],
            "threshold": "1188 prior records retained, 104 added and six source hulls",
            "value": envelope["checks"],
        },
        "degree_thirty_three_design_only_resource_contract_reproduces": {
            "passed": resource["passed"],
            "threshold": "registered exact combinatorial resources with zero relations",
            "value": resource["checks"],
        },
        "no_degree_thirty_three_relation_object_is_constructed": {
            "passed": bool(
        ...
        "section_digests_runner_and_json_are_strict": {
            "passed": bool(
                ...
                == len(resource_digest)
                == 64
                and runner["filename"] == "q011bu_degree33_resource_estimate.py"
    ...
    cycle = {
        "question": (
            "Can the degree-thirty-three block-support-coalesced full sweep be "
    ...
    cycle["theorem_consequence"] = {
        "degree_thirty_three_coalesced_full_sweep_preregistration_is_resource_supported": decision
        == GO_DECISION,
        "degree_thirty_three_external_nonresonance_is_certified": False,
        "an_actual_degree_thirty_three_external_resonance_is_ruled_out": False,
        "certified_external_nonresonance_degrees": list(range(2, 33)),
        "degree_91_and_higher_modulus_tail_is_preserved": True,
        "missing_external_nonresonance_degrees": list(range(33, 91)),
        "all_spectral_quotient_nonresonances_are_certified": False,
        "ssm_existence_or_uniqueness_is_certified": False,
        "normal_attraction_or_a_basin_is_certified": False,
        "q011bt_degree_thirty_two_certificate_is_preserved": True,
    }
    cycle["claim_boundary"] = (
        "This design-only audit concerns the degree-thirty-three modulus-overlap "
        "inventory, six Q011as source hulls, all 1128 current target discs, the "
        "1292-record monotone proof inventory, exact combinatorial resource counts and "
        "calibrated projections for the fixed 17x17 repaired exact map on one fixed "
        "conservation leaf. It evaluates no degree-thirty-three product-target relation "
        "and certifies no degree-thirty-three nonresonance, actual resonance, minimum "
    ...
    cycle["next_change"] = (
        "Preregister the Q011bv degree-thirty-three full sweep with fixed inputs, "
        "arithmetic and acceptance rules."
        if decision == GO_DECISION
        else "Redesign only the first failed degree-thirty-three resource dimension "
        "before any degree-thirty-three relation evaluation."
        if decision == STOP_DECISION
        else "Repair only the first Q011bu validity failure before changing the design."
    )
    if not (
        ...
        raise RuntimeError("Q011bu cycle failed strict serialization or digest")
    return cycle


def run_q011bu_study() -> dict[str, Any]:
    cycle = run_degree_thirty_three_resource_audit()
    resource = cycle["degree_thirty_three_coalesced_resource_audit"]
    return {
        "schema_version": 1,
        ...
        "arithmetic_runtime": {
            ...
            "degree_thirty_three_product_enclosure": "not constructed",
            "degree_thirty_three_fourier_coefficient_matrices": "not constructed",
            "degree_thirty_three_relation_classification": "not evaluated",
        ...
        "mathematical_scope": {
            "diagnostic": "design-only degree-33 block-support resource feasibility",
            "grid": [SIZE, SIZE],
            "fixed_conservation_leaf": True,
            "degree": DEGREE,
            "degree_thirty_three_external_nonresonance_claim": False,
            "actual_degree_thirty_three_external_resonance_ruled_out_claim": False,
